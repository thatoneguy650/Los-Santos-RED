...
public static class Surrendering
{
    public static void RaiseHands()
    {
        ...
        if (Game.LocalPlayer.WantedLevel > 0 && Police.CurrentCrimes.CopsKilledByPlayer < 5)
    ...
    public static void SetArrestedAnimation(Ped PedToArrest, bool MarkAsNoLongerNeeded)
    {
        ...
        {
            InstantAction.RequestAnimationDictionay("veh@busted_std");
            InstantAction.RequestAnimationDictionay("busted");
            InstantAction.RequestAnimationDictionay("ped");
    ...
    public static void UnSetArrestedAnimation(Ped PedToArrest)
    {
        ...
        {
            InstantAction.RequestAnimationDictionay("random@arrests");
            InstantAction.RequestAnimationDictionay("busted");
            InstantAction.RequestAnimationDictionay("ped");
    ...
    public static void CommitSuicide(Ped PedToSuicide)
    {
        GameFiber Suicide = GameFiber.StartNew(delegate
        {
            ...
            {
                InstantAction.RequestAnimationDictionay("mp_suicide");
