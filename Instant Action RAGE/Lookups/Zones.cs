...
public static class Zones
{
    ...
    public static readonly List<Zone> ZoneList = new List<Zone>(new[]
    {
        ...
        new Zone("ELYSIAN", "Elysian Island",ScannerAudio.areas.ElysianIsland.FileName,Agencies.LSPA,new List<Agency>() { Agencies.LSPD, Agencies.IAA,Agencies.DOA,Agencies.FIB }),
        ...
        new Zone("TERMINA", "Terminal",ScannerAudio.areas.Terminal.FileName,Agencies.LSPA,new List<Agency>() { Agencies.LSPD, Agencies.IAA,Agencies.DOA,Agencies.FIB }),
