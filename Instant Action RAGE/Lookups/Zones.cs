...
public static class Zones
{
    ...
    public static void Initialize()
    {
        ...
        CHIL = new Zone("CHIL", "Vinewood Hills", ScannerAudio.areas.VinewoodHills.FileName, County.LosSantosCounty, Agencies.VWPD, new List<Agency>() { Agencies.IAA, Agencies.DOA, Agencies.FIB }, new List<string>() { ScannerAudio.attention_all_area_units.VinewoodHillsUnits.FileName, ScannerAudio.attention_all_area_units.VinewoodHillsUnits1.FileName, ScannerAudio.attention_all_area_units.VinewoodHillsUnits3.FileName });
        CHU = new Zone("CHU", "Chumash", ScannerAudio.areas.Chumash.FileName, County.LosSantosCounty, Agencies.LSSD, new List<Agency>() { Agencies.DOA }, new List<string>() { ScannerAudio.attention_all_area_units.ChumashUnits.FileName, ScannerAudio.attention_all_area_units.ChumashUnits1.FileName, ScannerAudio.attention_all_area_units.ChumashUnits2.FileName });
        ...
        DTVINE = new Zone("DTVINE", "Downtown Vinewood", ScannerAudio.areas.DowntownVinewood.FileName, County.CityOfLosSantos, Agencies.VWPD, new List<Agency>() { Agencies.IAA, Agencies.DOA, Agencies.FIB }, new List<string>() { ScannerAudio.attention_all_area_units.VinewoodAreaUnits.FileName, ScannerAudio.attention_all_area_units.VinewoodUnits2.FileName });
        EAST_V = new Zone("EAST_V", "East Vinewood", ScannerAudio.areas.EastVinewood.FileName, County.CityOfLosSantos, Agencies.VWPD, new List<Agency>() { Agencies.IAA, Agencies.DOA, Agencies.FIB }, new List<string>() { ScannerAudio.attention_all_area_units.VinewoodAreaUnits.FileName, ScannerAudio.attention_all_area_units.VinewoodUnits2.FileName });
        ...
        HAWICK = new Zone("HAWICK", "Hawick", "", County.CityOfLosSantos, Agencies.VWPD, new List<Agency>() { Agencies.IAA, Agencies.DOA, Agencies.FIB }, new List<string>() { ScannerAudio.attention_all_area_units.VinewoodAreaUnits.FileName, ScannerAudio.attention_all_area_units.VinewoodUnits2.FileName });
        HORS = new Zone("HORS", "Vinewood Racetrack", ScannerAudio.areas.TheRaceCourse.FileName, County.CityOfLosSantos, Agencies.VWPD, new List<Agency>() { Agencies.IAA, Agencies.DOA, Agencies.FIB }, new List<string>() { ScannerAudio.attention_all_area_units.VinewoodAreaUnits.FileName, ScannerAudio.attention_all_area_units.VinewoodUnits2.FileName });
        ...
        RGLEN = new Zone("RGLEN", "Richman Glen", ScannerAudio.areas.RichmanGlenn.FileName, County.LosSantosCounty, Agencies.RHPD);
        ...
        VINE = new Zone("VINE", "Vinewood", ScannerAudio.areas.Vinewood.FileName, County.CityOfLosSantos, Agencies.VWPD, new List<Agency>() { Agencies.IAA, Agencies.DOA, Agencies.FIB }, new List<string>() { ScannerAudio.attention_all_area_units.VinewoodAreaUnits.FileName, ScannerAudio.attention_all_area_units.VinewoodUnits2.FileName });
        ...
        WVINE = new Zone("WVINE", "West Vinewood", ScannerAudio.areas.WestVinewood.FileName, County.CityOfLosSantos, Agencies.VWPD, new List<Agency>() { Agencies.IAA, Agencies.DOA, Agencies.FIB }, new List<string>() { ScannerAudio.attention_all_area_units.VinewoodAreaUnits.FileName, ScannerAudio.attention_all_area_units.VinewoodUnits2.FileName });
        ZANCUDO = new Zone("ZANCUDO", "Zancudo River", ScannerAudio.areas.ZancudoRiver.FileName, County.BlaineCounty, Agencies.SAPR,null, new List<string>() { ScannerAudio.attention_all_area_units.ZancudoRiverUnits.FileName });
...
public class Zone
{
    ...
    public Zone(string _GameName, string _TextName, string _ScannerValue, County _ZoneCounty, Agency _MainZoneAgency, List<Agency> _SecondaryZoneAgencies, List<string> _DispatchUnitAudio)
    {
        GameName = _GameName;
        TextName = _TextName;
        ScannerValue = _ScannerValue;
