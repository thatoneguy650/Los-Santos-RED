...
public static class Zones
{
    ...
    public static readonly List<Zone> ZoneList = new List<Zone>(new[]
    {
        ...
        new Zone("CALAFB", "Calafia Bridge","",PoliceDispatchType.SAPR),
        new Zone("CANNY", "Raton Canyon",ScannerAudio.areas.RatonCanyon.FileName,PoliceDispatchType.SAPR),
        new Zone("CCREAK", "Cassidy Creek","",PoliceDispatchType.SAPR),
        ...
        new Zone("CMSW", "Chiliad Mountain State Wilderness",ScannerAudio.areas.ChilliadMountainStWilderness.FileName,PoliceDispatchType.SAPR),
        ...
        new Zone("DELSOL", "Puerto Del Sol",ScannerAudio.areas.LaPorta.FileName,PoliceDispatchType.LSPD),
        new Zone("DESRT", "Grand Senora Desert",ScannerAudio.areas.GrandeSonoranDesert.FileName,PoliceDispatchType.Sheriff),
        ...
        new Zone("GALFISH", "Galilee",ScannerAudio.areas.GalileoPark.FileName,PoliceDispatchType.SAPR),
        ...
        new Zone("GREATC", "Great Chaparral",ScannerAudio.areas.GreatChapparalle.FileName,PoliceDispatchType.SAPR),
        ...
        new Zone("MTCHIL", "Mount Chiliad",ScannerAudio.areas.MountChiliad.FileName,PoliceDispatchType.SAPR),
        new Zone("MTGORDO", "Mount Gordo",ScannerAudio.areas.MountGordo.FileName,PoliceDispatchType.SAPR),
        ...
        new Zone("PALFOR", "Paleto Forest",ScannerAudio.areas.PaletoForest.FileName,PoliceDispatchType.SAPR),
        ...
        new Zone("PBLUFF", "Pacific Bluffs",ScannerAudio.areas.PacificBluffs.FileName,PoliceDispatchType.LSPD),
        ...
        new Zone("SANCHIA", "San Chianski Mountain Range","",PoliceDispatchType.SAPR),
        ...
        new Zone("TATAMO", "Tataviam Mountains",ScannerAudio.areas.TatathiaMountains.FileName,PoliceDispatchType.Sheriff),
        ...
        new Zone("VCANA", "Vespucci Canals",ScannerAudio.areas.VespucciCanal.FileName,PoliceDispatchType.LSPD),
        ...
        new Zone("ZANCUDO", "Zancudo River",ScannerAudio.areas.ZancudoRiver.FileName,PoliceDispatchType.SAPR),
