...
public static class VehicleLookup
{
    ...
    public static void SetupVehicleList()
    {
        ...
        Vehicles.Add(new VehicleInfo("monroe", 0xE62B361B, Manufacturer.Unknown, VehicleClass.SportsClassic, ScannerAudio.model.MONROE01.FileName));
        ...
        Vehicles.Add(new VehicleInfo("nemesis", 0xDA288376, Manufacturer.Principe, VehicleClass.Motorcycle, ScannerAudio.model.NEMESIS01.FileName));
        ...
        Vehicles.Add(new VehicleInfo("oracle", 0x506434F6, Manufacturer.Übermacht, VehicleClass.Coupe, ScannerAudio.model.ORACLE01.FileName));
        Vehicles.Add(new VehicleInfo("oracle2", 0xE18195B2, Manufacturer.Übermacht, VehicleClass.Coupe, ScannerAudio.model.ORACLE01.FileName));
        ...
        Vehicles.Add(new VehicleInfo("patriot", 0xCFCFEB3B, Manufacturer.Mammoth, VehicleClass.SUV, ScannerAudio.model.PATRIOT01.FileName));
        Vehicles.Add(new VehicleInfo("patriot2", 0xE6E967F8, Manufacturer.Mammoth, VehicleClass.SUV, ScannerAudio.model.PATRIOT01.FileName));
        ...
        Vehicles.Add(new VehicleInfo("pcj", 0xC9CEAF06, Manufacturer.Shitzu, VehicleClass.Motorcycle, ScannerAudio.model.PCJ60001.FileName));
        ...
        Vehicles.Add(new VehicleInfo("peyote", 0x6D19CCBC, Manufacturer.Unknown, VehicleClass.SportsClassic, ScannerAudio.model.PEYOTE01.FileName));
        ...
        Vehicles.Add(new VehicleInfo("pony", 0xF8DE29A8, Manufacturer.Unknown, VehicleClass.Van, ScannerAudio.model.PONY01.FileName));
        Vehicles.Add(new VehicleInfo("pony2", 0x38408341, Manufacturer.Unknown, VehicleClass.Van, ScannerAudio.model.PONY01.FileName));
        ...
        Vehicles.Add(new VehicleInfo("prairie", 0xA988D3A2, Manufacturer.Bollokan, VehicleClass.Compact, ScannerAudio.model.PRAIRIE01.FileName));
        ...
        Vehicles.Add(new VehicleInfo("premier", 0x8FB66F9B, Manufacturer.Unknown, VehicleClass.Sedan, ScannerAudio.model.PREMIER01.FileName));
        Vehicles.Add(new VehicleInfo("primo", 0xBB6B404F, Manufacturer.Albany, VehicleClass.Sedan, ScannerAudio.model.PRIMO01.FileName));
        Vehicles.Add(new VehicleInfo("primo2", 0x86618EDA, Manufacturer.Albany, VehicleClass.Sedan, ScannerAudio.model.PRIMO01.FileName));
        ...
        Vehicles.Add(new VehicleInfo("radi", 0x9D96B45B, Manufacturer.Unknown, VehicleClass.SUV, ScannerAudio.model.RADI01.FileName));
        ...
        Vehicles.Add(new VehicleInfo("rapidgt3", 0x7A2EF5E4, Manufacturer.Dewbauchee, VehicleClass.SportsClassic, ScannerAudio.model.RAPIDGT01.FileName));
        ...
        Vehicles.Add(new VehicleInfo("regina", 0xFF22D208, Manufacturer.Dundreary, VehicleClass.Sedan, ScannerAudio.model.REGINA01.FileName));
        ...
        Vehicles.Add(new VehicleInfo("rocoto", 0x7F5C91F1, Manufacturer.Obey, VehicleClass.SUV, ScannerAudio.model.ROCOTO01.FileName));
        Vehicles.Add(new VehicleInfo("rogue", 0xC5DD6967, Manufacturer.WesternCompany, VehicleClass.Plane));
        Vehicles.Add(new VehicleInfo("romero", 0x2560B2FC, Manufacturer.Chariot, VehicleClass.Sedan, ScannerAudio.model.HEARSE01.FileName));
