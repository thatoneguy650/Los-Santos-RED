...
public static class CrimeManager
{
    ...
    public static Crime KillingPolice { get; private set; }
    public static Crime FiringWeaponNearPolice { get; private set; }
    public static Crime TerroristActivity { get; private set; }
    public static Crime BrandishingHeavyWeapon { get; private set; }
    public static Crime AimingWeaponAtPolice { get; private set; }
    public static Crime HurtingPolice { get; private set; }
    public static Crime TrespessingOnGovtProperty { get; private set; }
    public static Crime GotInAirVehicleDuringChase { get; private set; }
    public static Crime FiringWeapon { get; private set; }
    public static Crime KillingCivilians { get; private set; }
    public static Crime GrandTheftAuto { get; private set; }
    public static Crime DrivingStolenVehicle { get; private set; }
    public static Crime Mugging { get; private set; }
    public static Crime AttemptingSuicide { get; private set; }
    public static Crime BrandishingWeapon { get; private set; }
    public static Crime BrandishingCloseCombatWeapon { get; private set; }   
    public static Crime HitPedWithCar { get; private set; }
    public static Crime HurtingCivilians { get; private set; }
    public static Crime HitCarWithCar { get; private set; }
    public static Crime ChangingPlates { get; private set; }
    public static Crime ResistingArrest { get; private set; }
    public static Crime DrivingAgainstTraffic { get; private set; }
    public static Crime DrivingOnPavement { get; private set; }
    public static Crime NonRoadworthyVehicle { get; private set; }
    public static Crime FelonySpeeding { get; private set; }
    public static Crime RunningARedLight { get; private set; }
    public static Crime DrunkDriving { get; private set; }
    public static Crime SuspiciousActivity { get; private set; }
