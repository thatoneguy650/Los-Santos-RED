...
public static class PoliceEquipment
{
    ...
    private class EquipedCop
    {
        ...
        public void IssueWeapons()
        {
            if (CopToArm != null)
            {
                ...
                if (General.MySettings.Police.IssuePoliceHeavyWeapons && WantedLevelScript.IsDeadlyChase && !HasHeavyWeapon)
                {
                    CheckIssueHeavy();
                }
            }
        ...
        public void ArmCopAppropriately()
        {
            if (CopToArm.ShouldAutoSetWeaponState)
            {
                ...
                {
                    if (CopToArm.IsInVehicle && PlayerState.WantedLevel < 4)
                    {
                        SetUnarmed();
                    }
                    else
        ...
        {
            if (General.MySettings.Police.IssuePoliceHeavyWeapons && WantedLevelScript.IsDeadlyChase && !HasHeavyWeapon && CopToArm.IsInVehicle)
                IssueHeavyWeapon();
        }
        public void IssuePistol()
        {
            ...
            Pistol = Weapons.GetWeapon(PistolToPick.ModelName);
            IssuedPistol = Pistol;
            if (IssuedPistol == null)
            {
                return;
        ...
        public void IssueHeavyWeapon()
        {
            ...
            IssuedHeavy = Weapons.GetWeapon(HeavyToPick.ModelName);
        ...
        public void SetUnarmed()
        {
            ...
            if (General.MySettings.Police.OverridePoliceAccuracy)
                CopToArm.Pedestrian.Accuracy = General.MySettings.Police.PoliceGeneralAccuracy;
        ...
        public void SetLessLethal()
        {
            ...
            if (General.MySettings.Police.OverridePoliceAccuracy)
                CopToArm.Pedestrian.Accuracy = General.MySettings.Police.PoliceTazerAccuracy;
