...
public class Menu
{
    ...
    private void ActionsMenuSelect(UIMenu sender, UIMenuItem selectedItem, int index)
    {
        ...
        {
            PlateTheft plateTheft = new PlateTheft(Player);
            plateTheft.ChangePlate(Player.SpareLicensePlates[SelectedPlateIndex]);
        }
    ...
    private void CreateActionsMenu()
    {
        ...
        menuMainChangeLicensePlate = new UIMenuListItem("Change Plate", "Change your license plate if you have spares.", Player.SpareLicensePlates); //new UIMenuItem("Change Plate", "Change your license plate if you have spares");
    ...
    private void CreateDeathMenu()
    {
        ...
        if (Settings.SettingsManager.General.UndieLimit == 0 || Player.TimesDied < Settings.SettingsManager.General.UndieLimit)
    ...
    private void DebugMenuSelect(UIMenu sender, UIMenuItem selectedItem, int index)
    {
        ...
        if (selectedItem == menuDebugGiveMoney) Player.GiveMoney(50000);
