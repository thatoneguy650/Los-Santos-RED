...
public class PedDamage
{
    ...
    private void AddPedsToTrack()
    {
        ...
        foreach (PedExt Civilian in Mod.World.Pedestrians.Civilians.Where(x => x.Pedestrian.Exists() && x.Pedestrian.IsAlive))
        {
    ...
    private class PedHealthState
    {
        ...
        private void BandagePed(Ped PedToBandage)
        {
            ...
            GameFiber Bandaging = GameFiber.StartNew(delegate
            {
                ...
                //    Mod.Debugging.WriteToLog("BandagePed", string.Format("Started Bandaging Animation"));
                //}
                ...
                if (IsFinished)
                {
                    ...
                    Mod.Debug.WriteToLog("BandagePed", string.Format("Finished, Not Bleeding"));
                    IsBleeding = false;
                ...
                {
                    Mod.Debug.WriteToLog("BandagePed", string.Format("Interrupted"));
                }
            ...
            Mod.Debug.GameFibers.Add(Bandaging);
        }
