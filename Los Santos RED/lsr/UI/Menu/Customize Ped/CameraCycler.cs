...
public class CameraCycler
{
    ...
    public CameraCycler(Camera charCam, IPedSwappable player, PedCustomizer pedCustomizer)
    { 
        Player = player;
        PedCustomizer = pedCustomizer;
        CharCam = charCam;
        DefaultPosition = new CameraCyclerPosition("Default", PedCustomizer.DefaultCameraPosition, PedCustomizer.DefaultCameraDirection, PedCustomizer.DefaultCameraRotation, 0);
    }
    public void Setup()
    {
