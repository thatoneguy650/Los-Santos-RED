...
public class Investigations
{
    ...
    private void InvestigationTick()
    {
        ...
        if (Mod.Player.IsNotWanted && InInvestigationMode && NearInvestigationPosition && HavePlayerDescription && Mod.World.PolicePerception.AnyCanRecognizePlayer && Mod.Player.CurrentPoliceResponse.HasBeenNotWantedFor >= 5000)
        {
