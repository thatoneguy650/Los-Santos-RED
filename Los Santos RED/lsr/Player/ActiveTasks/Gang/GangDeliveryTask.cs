    ...
    public class GangDeliveryTask
    {
        ...
        private void SendInitialInstructionsMessage()
        {
            List<string> Replies = new List<string>() {
                    $"The boss wants you to find us {NumberOfItemsToDeliver} {ItemToDeliver.MeasurementName}(s) of {ItemToDeliver.Name}. We need it quick. Bring it to the {HiringGang.DenName} on {HiringGangDen.StreetAddress}. ${MoneyToRecieve}",
                    $"Go get {NumberOfItemsToDeliver} {ItemToDeliver.MeasurementName}(s) of {ItemToDeliver.Name} from somewhere, I don't wanna know. Don't take too long. Bring it to the {HiringGang.DenName} on {HiringGangDen.StreetAddress}. ${MoneyToRecieve} to you when you drop it off",
                    $"We need you to find {NumberOfItemsToDeliver} {ItemToDeliver.MeasurementName}(s) of {ItemToDeliver.Name}. We can't wait all week. Take it to the {HiringGang.DenName} on {HiringGangDen.StreetAddress}. You'll get ${MoneyToRecieve} when I get my item.",
                    };
