...
public class Respawning// : IRespawning
{
    ...
    {
        ResetPlayer(false, false, false, false, false, false, false, false);
    ...
    public void RespawnAtCurrentLocation(bool withInvicibility, bool resetWanted, bool clearCriminalHistory, bool clearInventory)
    {
        if (CanUndie)
        {
            Respawn(resetWanted, true, false, false, clearCriminalHistory, clearInventory, false, false);
    ...
    {
        FadeOut();
        Respawn(true, true, true, Settings.SettingsManager.RespawnSettings.RemoveWeaponsOnDeath, true, false, true, false);
    ...
    public void SurrenderToPolice(GameLocation PoliceStation)
    {
        ...
        ResetPlayer(true, true, false, Settings.SettingsManager.RespawnSettings.RemoveWeaponsOnSurrender, true, false, true, false);
    ...
    {
        CurrentPlayer.Reset(resetWanted, resetTimesDied, clearWeapons, clearCriminalHistory, clearInventory, clearIntoxication, resetGangRelationships);
    ...
    private void Respawn(bool resetWanted, bool resetHealth, bool resetTimesDied, bool clearWeapons, bool clearCriminalHistory, bool clearInventory, bool clearIntoxication, bool resetGangRelationships)
    {
        try
        {
            ResurrectPlayer(resetTimesDied);
            ResetPlayer(resetWanted, resetHealth, resetTimesDied, clearWeapons, clearCriminalHistory, clearInventory, clearIntoxication, resetGangRelationships);
            Game.HandleRespawn();
            Time.UnPauseTime();
