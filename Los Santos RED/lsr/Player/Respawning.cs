...
public class Respawning// : IRespawning
{
    ...
    public bool BribePolice(int Amount)
    {
        ...
        {
            ResetPlayer(true, false, false, false, true, false, false, false, false, false);
    ...
    {
        ResetPlayer(false, false, false, false, false, false, false, false, false, false);
    ...
    public void RespawnAtCurrentLocation(bool withInvicibility, bool resetWanted, bool clearCriminalHistory, bool clearInventory)
    {
        if (CanUndie)
        {
            Respawn(resetWanted, true, false, false, clearCriminalHistory, clearInventory, false, false, false, false);
    ...
    {
        FadeOut();
        Respawn(true, true, true, Settings.SettingsManager.RespawnSettings.RemoveWeaponsOnDeath, true, false, true, false, false, false);
    ...
    public void SurrenderToPolice(GameLocation PoliceStation)
    {
        ...
        ResetPlayer(true, true, false, Settings.SettingsManager.RespawnSettings.RemoveWeaponsOnSurrender, true, false, true, false, false, false);
    ...
    private void ResetPlayer(bool resetWanted, bool resetHealth, bool resetTimesDied, bool clearWeapons, bool clearCriminalHistory, bool clearInventory, bool clearIntoxication, bool resetGangRelationships, bool clearVehicleOwnership, bool resetCellphone)
    {
        CurrentPlayer.Reset(resetWanted, resetTimesDied, clearWeapons, clearCriminalHistory, clearInventory, clearIntoxication, resetGangRelationships, clearVehicleOwnership, resetCellphone);
    ...
    private void Respawn(bool resetWanted, bool resetHealth, bool resetTimesDied, bool clearWeapons, bool clearCriminalHistory, bool clearInventory, bool clearIntoxication, bool resetGangRelationships, bool clearOwnedVehicles, bool resetCellphone)
    {
        try
        {
            ...
            ResetPlayer(resetWanted, resetHealth, resetTimesDied, clearWeapons, clearCriminalHistory, clearInventory, clearIntoxication, resetGangRelationships, clearOwnedVehicles, resetCellphone);
            Game.HandleRespawn();
            Time.UnPauseTime();
