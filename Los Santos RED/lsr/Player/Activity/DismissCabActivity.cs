...
public class DismissCabActivity : DynamicActivity
{
    ...
    public DismissCabActivity(IActionable currentPlayer, IEntityProvideable world, ISettingsProvideable settings)
    {
    ...
    public override bool CanPerform(IActionable player)
    {
        ...
        Game.DisplayHelp($"Cannot Release Taxi");
        return false;
    }
    public void WaveHands()
    {
        Player.WeaponEquipment.SetUnarmed();
        string Animation = "forget_it";
