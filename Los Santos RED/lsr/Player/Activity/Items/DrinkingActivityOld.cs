...
{
    public class DrinkingActivityOld : DynamicActivity
    {
        ...
        public DrinkingActivityOld(IActionable consumable, ISettingsProvideable settings, DrinkItem modItem, IIntoxicants intoxicants) : base()
        {
            Player = consumable;
            Settings = settings;
            ModItem = modItem;
