...
public class VehicleEngine
{
    ...
    public void ToggleEngine(bool PerformAnimation, bool DesiredEngineStatus)
    {
        ...
        Mod.Debug.WriteToLog("ToggleEngine", string.Format("Start {0}", IsEngineRunning));
        ...
        TogglingEngine = false;
        Mod.Debug.WriteToLog("ToggleEngine", string.Format("End {0}", IsEngineRunning));
    }
    ...
    {
        Mod.Debug.WriteToLog("ToggleEngine", string.Format("EngineRunning: {0}",IsEngineRunning));
