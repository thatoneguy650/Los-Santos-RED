...
public class PedGrab : DynamicActivity
{
    ...
    public PedGrab(IInteractionable player, PedExt ped, ISettingsProvideable settings, ICrimes crimes, IModItems modItems, IEntityProvideable world)
    {
        Player = player;
        Ped = ped;
        Settings = settings;
