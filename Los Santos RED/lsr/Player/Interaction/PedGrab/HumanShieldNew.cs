...
public class HumanShieldNew : PedGrab
{
    ...
    public HumanShieldNew(IInteractionable player, PedExt ped, ISettingsProvideable settings, ICrimes crimes, IModItems modItems, IEntityProvideable world) : base(player,ped,settings,crimes,modItems, world)
    {
