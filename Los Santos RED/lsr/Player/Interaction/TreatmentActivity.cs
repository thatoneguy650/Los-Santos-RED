...
public class TreatmentActivity : DynamicActivity
{
    ...
    public TreatmentActivity(IInteractionable player, PedExt ped, ISettingsProvideable settings, ICrimes crimes, IModItems modItems)
    {
        Player = player;
        Ped = ped;
        Settings = settings;
