...
public class ModItems : IModItems
{
    ...
    private void DefaultConfig_Weapons()
    {
        PossibleItems.WeaponItems.AddRange(new List<WeaponItem>
        {
            ...
            new WeaponItem("Malloy/Brando Waterfront","Not for the risk averse. Make it count as you'll be reloading as much as you shoot.", true, ItemType.Weapons) { ModelName = "weapon_marksmanpistol",PoliceFindDuringPlayerSearchPercentage = 45},
            new WeaponItem("Vom Feuer M1888","Because sometimes revenge is a dish best served six times, in quick succession, right between the eyes.", true, ItemType.Weapons) { ModelName = "weapon_doubleaction",PoliceFindDuringPlayerSearchPercentage = 25},
            new WeaponItem("Vom Feuer Navy Revolver","A true museum piece. You want to know how the West was won - slow reload speeds and a whole heap of bloodshed.", true, ItemType.Weapons) { ModelName = "weapon_navyrevolver",PoliceFindDuringPlayerSearchPercentage = 45},
            ...
            new WeaponItem("Coil Tesla MP","", true, ItemType.Weapons) { ModelName = "weapon_stungun_mp",PoliceFindDuringPlayerSearchPercentage = 20},
            ...
            new WeaponItem("Vom Feuer IBS-12","Fully automatic shotgun with 8 round magazine and high rate of fire.", false, ItemType.Weapons) { ModelName = "weapon_assaultshotgun",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            new WeaponItem("Hawk & Little HLSG","More than makes up for its slow, pump-action rate of fire with its range and spread. Decimates anything in its projectile path.", false, ItemType.Weapons) { ModelName = "weapon_bullpupshotgun",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            new WeaponItem("Shrewsbury Taiga-12","The weapon to reach for when you absolutely need to make a horrible mess of the room. Best used near easy-wipe surfaces only.", true, ItemType.Weapons) { ModelName = "weapon_heavyshotgun",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            ...
            new WeaponItem("Shrewsbury Defender","How many effective tools for riot control can you tuck into your pants? Ok, two. But this is the other one.", true, ItemType.Weapons) { ModelName = "weapon_autoshotgun",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            new WeaponItem("Leotardo SPAZ-11","There's only one semi-automatic shotgun with a fire rate that sets the LSFD alarm bells ringing, and you're looking at it.", true, ItemType.Weapons) { ModelName = "weapon_combatshotgun",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},


            new WeaponItem("Red Beth Musket","Armed with nothing but muskets and a superiority complex, the Brits took over half the world. Own the gun that built an Empire.", true, ItemType.Weapons) { ModelName = "weapon_musket",PoliceFindDuringPlayerSearchPercentage = 100},

            //SMG
            new WeaponItem("Shrewsbury Luzi","Combines compact design with a high rate of fire at approximately 700-900 rounds per minute.", false, ItemType.Weapons) { ModelName = "weapon_microsmg",PoliceFindDuringPlayerSearchPercentage = 55, FindPercentage = 5 },
            ...
            new WeaponItem("Hawk & Little XPM","Lightweight, compact, with a rate of fire to die very messily for: turn any confined space into a kill box at the click of a well-oiled trigger.", true, ItemType.Weapons) { ModelName = "weapon_smg_mk2", FindPercentage = 5},
            new WeaponItem("Vom Feuer Fisher","A high-capacity submachine gun that is both compact and lightweight. Holds up to 30 bullets in one magazine.", false, ItemType.Weapons) { ModelName = "weapon_assaultsmg",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            ...
            new WeaponItem("Vom Feuer A5-1R","Combining long distance accuracy with a high capacity magazine, the Carbine Rifle can be relied on to make the hit.", false, ItemType.Weapons) { ModelName = "weapon_carbinerifle",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            new WeaponItem("Vom Feuer A5-1R MK2","This is bespoke, artisan firepower: you couldn't deliver a hail of bullets with more love and care if you inserted them by hand.", true, ItemType.Weapons) { ModelName = "weapon_carbinerifle_mk2",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 4, },
            new WeaponItem("Vom Feuer BFR","The most lightweight and compact of all assault rifles, without compromising accuracy and rate of fire.", false, ItemType.Weapons) { ModelName = "weapon_advancedrifle",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            new WeaponItem("Vom Feuer SL6","Combining accuracy, maneuverability, firepower and low recoil, this is an extremely versatile assault rifle for any combat situation.", false, ItemType.Weapons) { ModelName = "weapon_specialcarbine",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            new WeaponItem("Vom Feuer SL6 MK2","The jack of all trades just got a serious upgrade: bow to the master.", true, ItemType.Weapons) { ModelName = "weapon_specialcarbine_mk2",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            new WeaponItem("Hawk & Little ZBZ-23","The latest Chinese import taking America by storm, this rifle is known for its balanced handling. Lightweight and very controllable in automatic fire.", false, ItemType.Weapons) { ModelName = "weapon_bullpuprifle",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            new WeaponItem("Hawk & Little ZBZ-25X","So precise, so exquisite, it's not so much a hail of bullets as a symphony.", true, ItemType.Weapons) { ModelName = "weapon_bullpuprifle_mk2",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            ...
            new WeaponItem("Vom Feuer GUH-B4","This immensely powerful assault rifle was designed for highly qualified, exceptionally skilled soldiers. Yes, you can buy it.", false, ItemType.Weapons) { ModelName = "weapon_militaryrifle",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            new WeaponItem("Vom Feuer POCK","The no-holds barred 30-round answer to that eternal question: how do I get this guy off my back?", true, ItemType.Weapons) { ModelName = "weapon_heavyrifle",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 5},
            ...
            new WeaponItem("Vom Feuer LAR","Find out why it was called the right arm of the free world as you use it to shoot down police helicopters. Not so popular south of the border.",true,ItemType.Weapons) { ModelName = "weapon_battlerifle",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 7 },
            ...
            new WeaponItem("Vom Feuer BAT","Lightweight, compact machine gun that combines excellent maneuverability with a high rate of fire to devastating effect.", false, ItemType.Weapons) { ModelName = "weapon_combatmg",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 1},
            new WeaponItem("Vom Feuer M70E1","You can never have too much of a good thing: after all, if the first shot counts, then the next hundred or so must count for double.", true, ItemType.Weapons) { ModelName = "weapon_combatmg_mk2",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 1},
            new WeaponItem("Hawk & Little Kenan","Complete your look with a Prohibition gun. Looks great being fired from an Albany Roosevelt or paired with a pinstripe suit.", false, ItemType.Weapons) { ModelName = "weapon_gusenberg",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 1},
            ...
            new WeaponItem("Bartlett M92 Mk2","Far away, yet always intimate: if you're looking for a secure foundation for that long-distance relationship, this is it.", true, ItemType.Weapons) { ModelName = "weapon_heavysniper_mk2",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 1},
            new WeaponItem("Vom Feuer M23 DBS","Whether you're up close or a disconcertingly long way away, this weapon will get the job done. A multi-range tool for tools.", false, ItemType.Weapons) { ModelName = "weapon_marksmanrifle",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 1},
            new WeaponItem("Vom Feuer M23 DBS Scout","Known in military circles as The Dislocator, this mod set will destroy both the target and your shoulder, in that order.", true, ItemType.Weapons) { ModelName = "weapon_marksmanrifle_mk2",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 1},

            new WeaponItem("Vom Feuer 699 PCR","A rifle for perfectionists. Because why settle for right-between-the-eyes, when you could have right-through-the-superior-frontal-gyrus.", true, ItemType.Weapons) { ModelName = "weapon_precisionrifle",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 1},
            ...
            new WeaponItem("Hawk & Little MGL","A compact, lightweight grenade launcher with semi-automatic functionality. Holds up to 10 rounds.", false, ItemType.Weapons) { ModelName = "weapon_grenadelauncher",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 1},
            new WeaponItem("Hawk & Little MGL Smoke","A compact, lightweight grenade launcher with semi-automatic functionality. Holds up to 10 rounds. Fires only smoke rounds", false, ItemType.Weapons) { ModelName = "weapon_grenadelauncher_smoke",PoliceFindDuringPlayerSearchPercentage = 100, FindPercentage = 1},
                //Unused
