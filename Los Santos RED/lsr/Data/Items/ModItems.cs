    ...
    private void DefaultConfig_Drinks()
    {
        ModItemsList.AddRange(new List<ModItem> {
            ...
            new ModItem("Bottle of Raine Water", "The water that rich people drink, and the main reason why there are now entire continents of plastic bottles floating in the ocean", eConsumableType.Drink, ItemType.Drinks) { 
                ModelItem = new PhysicalItem("ba_prop_club_water_bottle", 18905, new Vector3(0.11f, -0.05f, 0.03f), new Rotator(-99.0f, 14.0f, 1.0f)),HealthChangeAmount = 20, ItemSubType = ItemSubType.Water },//slight clipping, no issyes
            new ModItem("Bottle of GREY Water", "Expensive water that tastes worse than tap!", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("h4_prop_battle_waterbottle_01a", 18905, new Vector3(0.11f, -0.05f, 0.03f), new Rotator(-99.0f, 14.0f, 1.0f)),HealthChangeAmount = 20,CleanupItemImmediately = true, ItemSubType = ItemSubType.Water},//lotsa clipping, does not have gravity
            new ModItem("Bottle of JUNK Energy", "The Quick Fix!", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_energy_drink", 18905, new Vector3(0.11f, -0.05f, 0.03f), new Rotator(-99.0f, 14.0f, 1.0f)),HealthChangeAmount = 30, ItemSubType = ItemSubType.Soda},//fine
            //Beer
            new ModItem("Bottle of PiBwasser", "Cheap 11% ABV fighting lager brewed in Germany for export only from rice, barley, hops and the fresh urine of Bavarian virgins", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_amb_beer_bottle", 18905, new Vector3(0.11f, -0.05f, 0.03f), new Rotator(-99.0f, 14.0f, 1.0f)),IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5, ItemSubType= ItemSubType.Beer},//is perfecto
            new ModItem("Bottle of A.M.", "Mornings Golden Shower", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_beer_am", 18905, new Vector3(0.11f, -0.18f, 0.08f), new Rotator(-109.0f, 3.0f, -4.0f)),IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType= ItemSubType.Beer},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Barracho", "Es Playtime!", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_beer_bar", 18905, new Vector3(0.11f, -0.18f, 0.08f), new Rotator(-109.0f, 3.0f, -4.0f)),IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType= ItemSubType.Beer},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Blarneys", "Making your mouth feel lucky", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_beer_blr", 18905, new Vector3(0.11f, -0.18f, 0.08f), new Rotator(-109.0f, 3.0f, -4.0f)),IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType= ItemSubType.Beer},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Jakeys", "Drink Outdoors With Jakey's", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_beer_jakey", 18905, new Vector3(0.11f, -0.18f, 0.08f), new Rotator(-109.0f, 3.0f, -4.0f)),IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType= ItemSubType.Beer},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Logger", "A classic American tasteless, watery beer, made by Rednecks for Rednecks. Now Chinese owned", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_beer_logger", 18905, new Vector3(0.11f, -0.18f, 0.08f), new Rotator(-109.0f, 3.0f, -4.0f)),IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType= ItemSubType.Beer},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Patriot", "Never refuse a patriot", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_beer_patriot", 18905, new Vector3(0.11f, -0.18f, 0.08f), new Rotator(-109.0f, 3.0f, -4.0f)),IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType= ItemSubType.Beer},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Pride", "Swallow Me", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_beer_pride", 18905, new Vector3(0.11f, -0.18f, 0.08f), new Rotator(-109.0f, 3.0f, -4.0f)),IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType= ItemSubType.Beer},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Stronzo", "Birra forte d'Italia", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_beer_stz", 18905, new Vector3(0.11f, -0.18f, 0.08f), new Rotator(-109.0f, 3.0f, -4.0f)),IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType= ItemSubType.Beer},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Dusche", "Das Ist Gut Ja!", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_beerdusche", 18905, new Vector3(0.11f, -0.18f, 0.08f), new Rotator(-109.0f, 3.0f, -4.0f)),IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType= ItemSubType.Beer},//Does not have gravity, attachmentis too far down
            //Liquor
            new ModItem("Bottle of 40 oz", "Drink like a true thug!", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_cs_beer_bot_40oz", 18905, new Vector3(0.11f, -0.05f, 0.03f), new Rotator(-99.0f, 14.0f, 1.0f)),IntoxicantName = "Low Proof Alcohol", ItemSubType= ItemSubType.Beer},
            new ModItem("Bottle of Sinsimito Tequila", "Extra Anejo 100% De Agave. 42% Alcohol by volume", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("h4_prop_h4_t_bottle_02a", 18905, new Vector3(0.11f, -0.05f, 0.03f), new Rotator(-99.0f, 14.0f, 1.0f)),IntoxicantName = "High Proof Alcohol",HealthChangeAmount = 15,CleanupItemImmediately = true, ItemSubType= ItemSubType.Liquor},
            new ModItem("Bottle of Cazafortuna Tequila", "Tequila Anejo. 100% Blue Agave 40% Alcohol by volume", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("h4_prop_h4_t_bottle_01a", 18905, new Vector3(0.11f, -0.05f, 0.03f), new Rotator(-99.0f, 14.0f, 1.0f)),IntoxicantName = "High Proof Alcohol",HealthChangeAmount = 15,CleanupItemImmediately = true, ItemSubType= ItemSubType.Liquor},
            //Cups & Cans
            new ModItem("Can of eCola", "Deliciously Infectious!", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("ng_proc_sodacan_01a", 18905, new Vector3(0.12f, -0.07f, 0.07f), new Rotator(-110.0f, 14.0f, 1.0f)),HealthChangeAmount = 10, ItemSubType= ItemSubType.Soda},
            new ModItem("Can of Sprunk", "Slurp Sprunk Mmm! Delicious", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("ng_proc_sodacan_01b", 18905, new Vector3(0.12f, -0.07f, 0.07f), new Rotator(-110.0f, 14.0f, 1.0f)),HealthChangeAmount = 10, ItemSubType= ItemSubType.Soda},
            new ModItem("Can of Orang-O-Tang", "Orange AND Tang! Orang-O-Tang!", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("prop_orang_can_01", 18905, new Vector3(0.13f, 0.01f, 0.02f), new Rotator(-110.0f, 16.0f, 0.0f)),HealthChangeAmount = 10, ItemSubType= ItemSubType.Soda},//needs better attachment
            ...
            new ModItem("Cup of eCola", "Deliciously Infectious!", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("ng_proc_sodacup_01a", 18905, new Vector3(0.09f, -0.18f, 0.11f), new Rotator(-104.0f, 14.0f, 3.0f)),HealthChangeAmount = 10, ItemSubType= ItemSubType.Soda},//has no gravity, too far down
            new ModItem("Cup of Sprunk", "Slurp Sprunk Mmm! Delicious", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("ng_proc_sodacup_01b", 18905, new Vector3(0.09f, -0.18f, 0.11f), new Rotator(-104.0f, 14.0f, 3.0f)),HealthChangeAmount = 10, ItemSubType= ItemSubType.Soda},//perfecto
            new ModItem("Cup of Coffee", "Finally something without sugar! Sugar on Request", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("p_ing_coffeecup_02", 18905, new Vector3(0.14f, 0.01f, 0.03f), new Rotator(-110.0f, 13.0f, 0.0f)),HealthChangeAmount = 10, ItemSubType = ItemSubType.Coffee},//perfecto
            new ModItem("Can of Hoplivion Double IPA", "So many hops it should be illegal.", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("h4_prop_h4_can_beer_01a", 18905, new Vector3(0.12f, -0.07f, 0.07f), new Rotator(-110.0f, 14.0f, 1.0f)),IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5},//pretty good, maybeslightly off
            ...
            new ModItem("High Noon Coffee", "Drip coffee, carbonated water, fruit syrup and taurine.", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("p_ing_coffeecup_01", 18905, new Vector3(0.14f, 0.01f, 0.03f), new Rotator(-110.0f, 13.0f, 0.0f)),HealthChangeAmount = 10, ItemSubType = ItemSubType.Coffee},//perfecto
            new ModItem("The Eco-ffee", "Decaf light, rain forest rain, saved whale milk, chemically reclaimed freerange organic tofu, and recycled brown sugar", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("p_ing_coffeecup_01", 18905, new Vector3(0.14f, 0.01f, 0.03f), new Rotator(-110.0f, 13.0f, 0.0f)),HealthChangeAmount = 12, ItemSubType = ItemSubType.Coffee},//perfecto
            new ModItem("Speedball Coffee", "Caffeine tripe-shot, guarana, bat guano, and mate.", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("p_ing_coffeecup_01", 18905, new Vector3(0.14f, 0.01f, 0.03f), new Rotator(-110.0f, 13.0f, 0.0f)),HealthChangeAmount = 15, ItemSubType = ItemSubType.Coffee},//perfecto
            new ModItem("Gunkacchino Coffee", "Caffeine, refined sugar, trans fat, high-fructose corn syrup, and cheesecake base.", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("p_ing_coffeecup_01", 18905, new Vector3(0.14f, 0.01f, 0.03f), new Rotator(-110.0f, 13.0f, 0.0f)),HealthChangeAmount = 17},//perfecto
            new ModItem("Bratte Coffee", "Double shot latte, and 100 pumps of caramel.", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("p_ing_coffeecup_01", 18905, new Vector3(0.14f, 0.01f, 0.03f), new Rotator(-110.0f, 13.0f, 0.0f)),HealthChangeAmount = 5, ItemSubType = ItemSubType.Coffee},//perfecto
            ...
            new ModItem("Caffeagra Coffee", "Caffeine (Straight up), rhino horn, oyster shell, and sildenafil citrate.", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("p_ing_coffeecup_01", 18905, new Vector3(0.14f, 0.01f, 0.03f), new Rotator(-110.0f, 13.0f, 0.0f)),HealthChangeAmount = 17, ItemSubType = ItemSubType.Coffee},//perfecto
            ...
            new ModItem("Jumbo Shake", "Almost a whole cow full of milk", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("ng_proc_sodacup_01c", 18905, new Vector3(0.09f, -0.18f, 0.11f), new Rotator(-104.0f, 14.0f, 3.0f)),HealthChangeAmount = 10, ItemSubType = ItemSubType.Milk},//no gravity, attached wrong
            //burger shot
            new ModItem("Double Shot Coffee", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("p_ing_coffeecup_01", 18905, new Vector3(0.14f, 0.01f, 0.03f), new Rotator(-110.0f, 13.0f, 0.0f)),HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType = ItemSubType.Coffee },//n gravity,not attached right
            new ModItem("Liter of eCola", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("ng_proc_sodacup_01a", 18905, new Vector3(0.09f, -0.18f, 0.11f), new Rotator(-104.0f, 14.0f, 3.0f)),HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType = ItemSubType.Soda},//n gravity,not attached right
            new ModItem("Liter of Sprunk", eConsumableType.Drink, ItemType.Drinks){
                ModelItem = new PhysicalItem("ng_proc_sodacup_01b", 18905, new Vector3(0.09f, -0.18f, 0.11f), new Rotator(-104.0f, 14.0f, 3.0f)),HealthChangeAmount = 5,CleanupItemImmediately = true, ItemSubType = ItemSubType.Soda },//n gravity,not attached right 
        });
    }
    private void DefaultConfig_Drugs()
    {
        ModItemsList.AddRange(new List<ModItem>
        {
            ...
            new ModItem("Redwood Regular", "Tobacco products for real men who don't go to the doctors or read fear-mongering, left-wing so-called medical propaganda",eConsumableType.Smoke, ItemType.Drugs) {
                ...
                PackageItem = new PhysicalItem("v_ret_ml_cigs",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -10, ItemSubType = ItemSubType.Cigarette },
            new ModItem("Redwood Mild", "Tobacco products for real men who don't go to the doctors or read fear-mongering, left-wing so-called medical propaganda. Milder version",eConsumableType.Smoke, ItemType.Drugs) {
                ModelItem = new PhysicalItem("ng_proc_cigarette01a",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),
                PackageItem = new PhysicalItem("v_ret_ml_cigs2",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -5, ItemSubType = ItemSubType.Cigarette },
            new ModItem("Debonaire", "Tobacco products marketed at the more sophisticated smoker, whoever that is",eConsumableType.Smoke, ItemType.Drugs) {
                ModelItem = new PhysicalItem("ng_proc_cigarette01a",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),
                PackageItem = new PhysicalItem("v_ret_ml_cigs3",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -10, ItemSubType = ItemSubType.Cigarette },
            new ModItem("Debonaire Menthol", "Tobacco products marketed at the more sophisticated smoker, whoever that is. With Menthol!",eConsumableType.Smoke, ItemType.Drugs) {
                ModelItem = new PhysicalItem("ng_proc_cigarette01a",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),
                PackageItem = new PhysicalItem("v_ret_ml_cigs4",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -10, ItemSubType = ItemSubType.Cigarette },
            new ModItem("Caradique", "Fine Napoleon Cigarettes",eConsumableType.Smoke, ItemType.Drugs) {
                ModelItem = new PhysicalItem("ng_proc_cigarette01a",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),
                PackageItem = new PhysicalItem("v_ret_ml_cigs5",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -10, ItemSubType = ItemSubType.Cigarette },
            new ModItem("69 Brand","Don't let an embargo stop you",eConsumableType.Smoke, ItemType.Drugs) {
                ModelItem = new PhysicalItem("ng_proc_cigarette01a",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),
                PackageItem = new PhysicalItem("v_ret_ml_cigs6",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -10, ItemSubType = ItemSubType.Cigarette },
            new ModItem("Estancia Cigar","Medium Cut. Hand Rolled.",eConsumableType.Smoke, ItemType.Drugs) {
                ...
                PackageItem = new PhysicalItem("p_cigar_pack_02_s",57005, new Vector3(0.17f, 0.02f, 0.0f),new Rotator(0.0f, -78f, 0f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -5, ItemSubType = ItemSubType.Cigar },
            ...
            new ModItem("Bull Shark Testosterone","More bite than bush elephant testosterone. Become more aggressive, hornier, and irresistible to women! The ultimate man!",eConsumableType.Ingest, ItemType.Drugs) {
                ModelItem = new PhysicalItem("prop_cs_pills",57005,new Vector3(0.12f, 0.03f, 0.0f),new Rotator(-76f, 0f, 0f)),IntoxicantName = "Bull Shark Testosterone" , AmountPerPackage = 10, ItemSubType = ItemSubType.Narcotic},
            new ModItem("Alco Patch","The Alco Patch. It's the same refreshing feeling of your favorite drink, but delivered transdermally and discreetly. Pick up the Alco Patch at your local pharmacy.",eConsumableType.Ingest, ItemType.Drugs) {
                ModelItem = new PhysicalItem("prop_cs_pills",57005,new Vector3(0.12f, 0.03f, 0.0f),new Rotator(-76f, 0f, 0f)),IntoxicantName = "Alco Patch",AmountPerPackage = 10, ItemSubType = ItemSubType.Narcotic},
            ...
            new ModItem("Mollis","For outstanding erections. Get the performance you've always dreamed of",eConsumableType.Ingest, ItemType.Drugs) {
                ModelItem = new PhysicalItem("prop_cs_pills",57005,new Vector3(0.12f, 0.03f, 0.0f),new Rotator(-76f, 0f, 0f)),IntoxicantName = "Mollis",AmountPerPackage = 10, ItemSubType = ItemSubType.Narcotic},
            new ModItem("Chesty","Cough suppressant manufactured by Good Aids Pharmacy. Gives 24-hour relief and is available in honey flavour.",eConsumableType.Ingest, ItemType.Drugs) {
                ModelItem = new PhysicalItem("prop_cs_pills",57005,new Vector3(0.12f, 0.03f, 0.0f),new Rotator(-76f, 0f, 0f)),IntoxicantName = "Chesty", AmountPerPackage = 10, ItemSubType = ItemSubType.Narcotic },
            new ModItem("Equanox","Combats dissatisfaction, lethargy, depression, melancholy, sexual dysfunction. Equanox may cause nausea, loss of sleep, blurred vision, leakage, kidney problems and breathing irregularities.",eConsumableType.Ingest, ItemType.Drugs) {
                ModelItem = new PhysicalItem("prop_cs_pills",57005,new Vector3(0.12f, 0.03f, 0.0f),new Rotator(-76f, 0f, 0f)),IntoxicantName = "Equanox", AmountPerPackage = 10, ItemSubType = ItemSubType.Narcotic },
            new ModItem("Zombix","Painkiller and antidepressant manufactured by O'Deas Pharmacy. ~n~'Go straight for the head.'",eConsumableType.Ingest, ItemType.Drugs) {
                ModelItem = new PhysicalItem("prop_cs_pills",57005,new Vector3(0.12f, 0.03f, 0.0f),new Rotator(-76f, 0f, 0f)),IntoxicantName = "Zombix", AmountPerPackage = 10, ItemSubType = ItemSubType.Narcotic },
            //Illegal Drugs
            new ModItem("Marijuana","Little Jacob Tested, Truth Approved",eConsumableType.Smoke, ItemType.Drugs) {
                ...
                ,PackageItem = new PhysicalItem("sf_prop_sf_bag_weed_01a",57005,new Vector3(0.0f, 0.0f, 0.0f),new Rotator(0f, 0f, 0f)), PercentLostOnUse = 0.25f, MeasurementName = "Gram", IntoxicantName = "Marijuana", RequiredToolType = ToolTypes.Lighter, ItemSubType = ItemSubType.Narcotic },
            new ModItem("SPANK","You looking for some fun? a little.. hmmm? Some SPANK?",eConsumableType.Ingest, ItemType.Drugs) { IsPossessionIllicit = true,
                ModelItem = new PhysicalItem("prop_cs_pills",57005,new Vector3(0.12f, 0.03f, 0.0f),new Rotator(-76f, 0f, 0f)),IntoxicantName = "SPANK", PercentLostOnUse = 0.5f, MeasurementName = "Gram", ItemSubType = ItemSubType.Narcotic },
            new ModItem("Toilet Cleaner","Meth brought you forbidden fruits of incest. Bath salts brought you the taboo joys of cannibalism. It's time to step things up a level. The hot new legal high that takes you to places you never imagined and leaves you forever changed - Toilet Cleaner.",eConsumableType.Ingest, ItemType.Drugs) { IsPossessionIllicit = true,
                ModelItem = new PhysicalItem("prop_cs_pills",57005,new Vector3(0.12f, 0.03f, 0.0f),new Rotator(-76f, 0f, 0f)),IntoxicantName = "Toilet Cleaner", ItemSubType = ItemSubType.Narcotic },
    ...
    private void DefaultConfig_Food()
    {
        ModItemsList.AddRange(new List<ModItem>
        {
            ...
            new ModItem("Hot Dog","Your favorite mystery meat sold on street corners everywhere. Niko would be proud",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_cs_hotdog_01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Entree },
            ...
            new ModItem("Burger","100% Certified Food",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_cs_burger_01",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Entree },
            new ModItem("Donut","MMMMMMM Donuts",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_donut_01",57005,new Vector3(0.15f, 0.01f, -0.03f),new Rotator(-15.0f, 17.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Snack } ,
            new ModItem("Bagel Sandwich","Bagel with extras, what more do you need?",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("p_amb_bagel_01",57005,new Vector3(0.15f, 0.01f, -0.03f),new Rotator(-15.0f, 17.0f, 0.0f)), HealthChangeAmount = 12, ItemSubType = ItemSubType.Entree } ,
            new ModItem("French Fries","Freedom fries made from true Cataldo potatoes!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_food_chips",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 5, ItemSubType = ItemSubType.Side },
            ...
            new ModItem("Banana","An elongated, edible fruit – botanically a berry[1][2] – produced by several kinds of large herbaceous flowering plants in the genus Musa",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("ng_proc_food_nana1a",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Fruit },
            new ModItem("Orange","Not just a color",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("ng_proc_food_ornge1a",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Fruit },
            new ModItem("Apple","Certified sleeping death free",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("ng_proc_food_aple1a",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Fruit },
            new ModItem("Ham and Cheese Sandwich","Basic and shitty, just like you",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_sandwich_01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Entree },
            ...
            new ModItem("Tuna Sandwich","Haven't got enough heavy metals in you at your job? Try tuna!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_sandwich_01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Entree } ,
            new ModItem("Taco",eConsumableType.Eat, ItemType.Food) { HealthChangeAmount = 10, ItemSubType = ItemSubType.Entree },
            ...
            new ModItem("Slice of Pizza","Caution may be hot",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("v_res_tt_pizzaplate",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("Small Cheese Pizza","Best when you are home alone.",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_02",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 25, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("Small Pepperoni Pizza","Get a load of our pepperonis!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_02",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 30, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("Small Supreme Pizza","Get stuffed",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_02",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 35, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("Medium Cheese Pizza","Best when you are home alone.",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_02",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 50, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("Medium Pepperoni Pizza","Get a load of our pepperonis!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_02",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 55, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("Medium Supreme Pizza","Get stuffed",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_02",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 60, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("Large Cheese Pizza","Best when you are home alone.",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_02",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 65, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("Large Pepperoni Pizza","Get a load of our pepperonis!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_02",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 70, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("Large Supreme Pizza","Get stuffed",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_02",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 75, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("10 inch Cheese Pizza","Extra cheesy!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_01",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 25, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("10 inch Pepperoni Pizza","Mostly Meat!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_01",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 30, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("10 inch Supreme Pizza","We forgot the kitchen sink!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_01",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 35, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("12 inch Cheese Pizza","Extra cheesy!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_01",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 50, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("12 inch Pepperoni Pizza","Mostly Meat!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_01",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 55, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("12 inch Supreme Pizza","We forgot the kitchen sink!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_01",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 60, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("18 inch Cheese Pizza","Extra cheesy! Extra Large!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_01",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 65, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("18 inch Pepperoni Pizza","Mostly Meat! Extra Large!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_01",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 70, ItemSubType = ItemSubType.Pizza } ,
            new ModItem("18 inch Supreme Pizza","We forgot the kitchen sink! Extra Large!",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_pizza_box_01",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 75, ItemSubType = ItemSubType.Pizza } ,
            //Chips
            new ModItem("Sticky Rib Phat Chips","They are extra phat. Sticky Rib Flavor.",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("v_ret_ml_chips1",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Snack },
            new ModItem("Habanero Phat Chips","They are extra phat. Habanero flavor",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("v_ret_ml_chips2",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Snack },
            new ModItem("Supersalt Phat Chips","They are extra phat. Supersalt flavor.",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("v_ret_ml_chips3",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Snack },
            new ModItem("Big Cheese Phat Chips","They are extra phat. Big Cheese flavor.",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("v_ret_ml_chips4",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Snack },
            //Candy
            new ModItem("Ego Chaser Energy Bar","Contains 20,000 Calories! ~n~'It's all about you'",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_choc_ego",57005,new Vector3(0.13f, 0.05f, -0.02f),new Rotator(25f, -11f, -95f)), HealthChangeAmount = 20, ItemSubType = ItemSubType.Snack },
            new ModItem("King Size P's & Q's","The candy bar that kids and stoners love. EXTRA Large",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_candy_pqs",57005,new Vector3(0.16f, 0.01f, -0.02f),new Rotator(-178f, -169f, 169f)), HealthChangeAmount = 15, ItemSubType = ItemSubType.Snack },
            new ModItem("P's & Q's","The candy bar that kids and stoners love",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_choc_pq",57005,new Vector3(0.12f, 0.02f, -0.02f),new Rotator(-178f, -169f, 79f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Snack },
            new ModItem("Meteorite Bar","Dark chocolate with a GOOEY core",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_choc_meto",57005,new Vector3(0.12f, 0.03f, -0.02f),new Rotator(169f, 170f, 76f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Snack },
            //UPNATOM
            ...
            new ModItem("Freedom Fries",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_food_bs_chips",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 5, ItemSubType = ItemSubType.Snack },
            //Bite
            new ModItem("Gut Buster Sandwich",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_food_burg2",57005,new Vector3(0.14f, 0.01f, -0.06f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Entree } ,
            ...
            new ModItem("Double Burger",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_cs_burger_01",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)), HealthChangeAmount = 12, ItemSubType = ItemSubType.Entree },
            new ModItem("Kingsize Burger",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_cs_burger_01",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)), HealthChangeAmount = 15, ItemSubType = ItemSubType.Entree },
            new ModItem("Bacon Burger",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_cs_burger_01",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)), HealthChangeAmount = 17, ItemSubType = ItemSubType.Entree },
            //Taco Bomb
            ...
            new ModItem("Balls & Rings",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_food_burg3",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 5, ConsumeOnPurchase = true, ItemSubType = ItemSubType.Side },
            ...
            new ModItem("Smokehouse Burger",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_cs_burger_01",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)), HealthChangeAmount = 20, ConsumeOnPurchase = true, ItemSubType = ItemSubType.Entree },
            ...
            new ModItem("Juek Suk tong Mandu",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_ff_noodle_01",57005,new Vector3(0.0f, 0.0f, 0.0f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 10, ItemSubType = ItemSubType.Entree },
            new ModItem("Hayan Jam Pong",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_ff_noodle_02",57005,new Vector3(0.0f, 0.0f, 0.0f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 15, ItemSubType = ItemSubType.Entree } ,
            new ModItem("Sal Gook Su Jam Pong",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_ff_noodle_01",57005,new Vector3(0.0f, 0.0f, 0.0f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 20, ItemSubType = ItemSubType.Entree } ,
            new ModItem("Chul Pan Bokkeum Jam Pong",eConsumableType.Eat, ItemType.Food) {
                ModelItem = new PhysicalItem("prop_ff_noodle_02",57005,new Vector3(0.0f, 0.0f, 0.0f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 20, ItemSubType = ItemSubType.Entree } ,
...
//            //Generic Services
//            new ModItem("Room: Single Twin","Cheapest room for the most discerning client",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },
//            new ModItem("Room: Single Queen","Clean sheets on request",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },
//            new ModItem("Room: Double Queen","Have a little company, but don't want to get too close?",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },
//            new ModItem("Room: Single King","Please clean off all mirrors after use",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },

//            //new ModItem("Scrap Vehicle","Sell the vehicle for scrap",eConsumableType.Service, ItemType.Service) { ConsumeOnPurchase = true, MeasurementName = "Vehicle" },

//            //new ModItem("Full",eConsumableType.Service, ItemType.Service),
//            //new ModItem("Half And Half",eConsumableType.Service, ItemType.Service),
//            //new ModItem("Head",eConsumableType.Service, ItemType.Service),
//            //new ModItem("Handy",eConsumableType.Service, ItemType.Service),
...
//            new ModItem("Hot Dog","Your favorite mystery meat sold on street corners everywhere. Niko would be proud",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_cs_hotdog_01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 10 },
//            new ModItem("Hot Sausage","Get all your jokes out",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_cs_hotdog_01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 10 },
//            new ModItem("Hot Pretzel","You tie me up",eConsumableType.Eat, ItemType.Food) {HealthChangeAmount = 10 },
//            new ModItem("3 Mini Pretzels","Like a pretzel, but smaller",eConsumableType.Eat, ItemType.Food) {HealthChangeAmount = 10 },
//            new ModItem("Nuts","You're gonna love my nuts",eConsumableType.Eat, ItemType.Food) {HealthChangeAmount = 10 },
...
//                ModelItem = new PhysicalItem("ba_prop_club_water_bottle",57005,new Vector3(0.12f, -0.1f, -0.07f),new Rotator(-70.0f, 0.0f, 0.0f)), HealthChangeAmount = 20 },

//            new ModItem("Bottle of GREY Water","Expensive water that tastes worse than tap!",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("h4_prop_battle_waterbottle_01a",57005,new Vector3(0.12f, -0.1f, -0.07f),new Rotator(-70.0f, 0.0f, 0.0f)), HealthChangeAmount = 20 },
...
//           // 18905,new Vector3(0.12f, -0.07f, 0.07f),new Rotator(-110.0f, 14.0f, 1.0f))
...
//            new ModItem("Bagel Sandwich","Bagel with extras, what more do you need?",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("p_amb_bagel_01",57005,new Vector3(0.15f, 0.01f, -0.03f),new Rotator(-15.0f, 17.0f, 0.0f)), HealthChangeAmount = 12 } ,

//            new ModItem("Bottle of JUNK Energy", "The Quick Fix!",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_energy_drink",57005,new Vector3(0.13f, -0.06f, -0.06f),new Rotator(-73.0f, 0.0f, 0.0f)) , HealthChangeAmount = 30},

//            new ModItem("Can of eCola", "Deliciously Infectious!",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("ng_proc_sodacan_01a",57005,new Vector3(0.13f, -0.06f, -0.06f),new Rotator(-73.0f, 0.0f, 0.0f)) , HealthChangeAmount = 10},
//            new ModItem("Can of Sprunk", "Slurp Sprunk Mmm! Delicious",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("ng_proc_sodacan_01b",57005,new Vector3(0.13f, -0.06f, -0.06f),new Rotator(-73.0f, 0.0f, 0.0f)), HealthChangeAmount = 10 },
//            new ModItem("Can of Orang-O-Tang", "Orange AND Tang! Orang-O-Tang!",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_orang_can_01",57005,new Vector3(0.13f, -0.06f, -0.06f),new Rotator(-73.0f, 0.0f, 0.0f)), HealthChangeAmount = 10 },

//            new ModItem("Carton of Milk", "Full Fat. Farmed and produced in U.S.A.",eConsumableType.Drink) { HealthChangeAmount = 10,
...
//                ModelItem = new PhysicalItem("prop_food_juice01",57005,new Vector3(0.07f, -0.1f, -0.1f),new Rotator(-74.0f, 28.0f, 3.0f)), HealthChangeAmount = 10 },
//            new ModItem("Cup of Sprunk", "Slurp Sprunk Mmm! Delicious",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("ng_proc_sodacup_01b",57005,new Vector3(0.07f, -0.1f, -0.1f),new Rotator(-74.0f, 28.0f, 3.0f)), HealthChangeAmount = 10 },
//            new ModItem("Cup of Coffee","Finally something without sugar! Sugar on Request",eConsumableType.Drink) {
//               ModelItem = new PhysicalItem("p_ing_coffeecup_02",57005,new Vector3(0.12f, -0.06f, -0.08f),new Rotator(-78.0f, 0.0f, 0.0f)), HealthChangeAmount = 10 }, //ModelItem = new PhysicalItem("prop_food_coffee",57005,new Vector3(0.12f, -0.06f, -0.08f),new Rotator(-78.0f, 0.0f, 0.0f)), HealthGained = 10 },

//            new ModItem("French Fries","Freedom fries made from true Cataldo potatoes!",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_chips",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 5 },
//            new ModItem("Fries","Freedom fries made from true Cataldo potatoes!",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_chips",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 5 },
//            new ModItem("Banana","An elongated, edible fruit – botanically a berry[1][2] – produced by several kinds of large herbaceous flowering plants in the genus Musa",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("ng_proc_food_nana1a",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10 },
//            new ModItem("Orange","Not just a color",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("ng_proc_food_ornge1a",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10 },
//            new ModItem("Apple","Certified sleeping death free",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("ng_proc_food_aple1a",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10 },
//            new ModItem("Ham and Cheese Sandwich","Basic and shitty, just like you",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_sandwich_01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 10 },
//            new ModItem("Turkey Sandwich","The most plain sandwich for the most plain person",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_sandwich_01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 10 } ,
//            new ModItem("Tuna Sandwich","Haven't got enough heavy metals in you at your job? Try tuna!",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_sandwich_01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 10 } ,
//            new ModItem("Taco",eConsumableType.Eat, ItemType.Food) { HealthChangeAmount = 10 },
//            new ModItem("Strawberry Rails Cereal","The breakfast food you snort!",eConsumableType.Eat, ItemType.Food) { HealthChangeAmount = 50,
//                //ModelItem = new PhysicalItem("v_res_tt_cereal01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)),
//            } ,
//            new ModItem("Crackles O' Dawn Cereal","Smile at the crack!",eConsumableType.Eat, ItemType.Food) { HealthChangeAmount = 60,
//                //ModelItem = new PhysicalItem("v_res_tt_cereal02",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)),
//            } ,
//            new ModItem("White Bread","Extra white, with minimal taste.",eConsumableType.Eat, ItemType.Food) { HealthChangeAmount = 10, AmountPerPackage = 25,
...
//                ModelItem = new PhysicalItem("prop_beer_am",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), IntoxicantName = "Low Proof Alcohol" , HealthChangeAmount = 5},
...
//                ModelItem = new PhysicalItem("prop_amb_beer_bottle",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5 },
//            new ModItem("Bottle of Barracho","Es Playtime!",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_beer_bar",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5},
//            new ModItem("Bottle of Blarneys","Making your mouth feel lucky",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_beer_blr",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5 },
//            new ModItem("Bottle of Jakeys","Drink Outdoors With Jakey's",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_beer_jakey",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5},
...
//                ModelItem = new PhysicalItem("prop_beer_logger",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5},
//            new ModItem("Bottle of Patriot","Never refuse a patriot",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_beer_patriot",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5 },
//            new ModItem("Bottle of Pride","Swallow Me",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_beer_pride",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)),IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5 },
//            new ModItem("Bottle of Stronzo","Birra forte d'Italia",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_beer_stz",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)),IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5 },
//            new ModItem("Bottle of Dusche","Das Ist Gut Ja!",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_beerdusche",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5},

//            new ModItem("Can of Hoplivion Double IPA","So many hops it should be illegal.",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("h4_prop_h4_can_beer_01a",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5},
...
//                IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5 },
...
//                ModelItem = new PhysicalItem("h4_prop_h4_t_bottle_02a",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), IntoxicantName = "High Proof Alcohol", HealthChangeAmount = 15},
//            new ModItem("Cazafortuna Tequila","Tequila Anejo. 100% Blue Agave 40% Alcohol by volume",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("h4_prop_h4_t_bottle_01a",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), IntoxicantName = "High Proof Alcohol", HealthChangeAmount = 15},

//            new ModItem("Sticky Rib Phat Chips","They are extra phat. Sticky Rib Flavor.",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("v_ret_ml_chips1",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10 },
//            new ModItem("Habanero Phat Chips","They are extra phat. Habanero flavor",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("v_ret_ml_chips2",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10 },
//            new ModItem("Supersalt Phat Chips","They are extra phat. Supersalt flavor.",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("v_ret_ml_chips3",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10 },
//            new ModItem("Big Cheese Phat Chips","They are extra phat. Big Cheese flavor.",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("v_ret_ml_chips4",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 10 },

//            new ModItem("Ego Chaser Energy Bar","Contains 20,000 Calories! ~n~'It's all about you'",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_choc_ego",57005,new Vector3(0.13f, 0.05f, -0.02f),new Rotator(25f, -11f, -95f)), HealthChangeAmount = 20 },
//            new ModItem("King Size P's & Q's","The candy bar that kids and stoners love. EXTRA Large",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_candy_pqs",57005,new Vector3(0.16f, 0.01f, -0.02f),new Rotator(-178f, -169f, 169f)), HealthChangeAmount = 15 },
//            new ModItem("P's & Q's","The candy bar that kids and stoners love",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_choc_pq",57005,new Vector3(0.12f, 0.02f, -0.02f),new Rotator(-178f, -169f, 79f)), HealthChangeAmount = 10 },
//            new ModItem("Meteorite Bar","Dark chocolate with a GOOEY core",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_choc_meto",57005,new Vector3(0.12f, 0.03f, -0.02f),new Rotator(169f, 170f, 76f)), HealthChangeAmount = 10 },
...
//                ModelItem = new PhysicalItem("ng_proc_cigarette01a",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),
//                PackageItem = new PhysicalItem("v_ret_ml_cigs",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -10 },
...
//                ModelItem = new PhysicalItem("ng_proc_cigarette01a",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),
//                PackageItem = new PhysicalItem("v_ret_ml_cigs2",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -5 },
//            new ModItem("Debonaire", "Tobacco products marketed at the more sophisticated smoker, whoever that is",eConsumableType.Smoke) {
//                ModelItem = new PhysicalItem("ng_proc_cigarette01a",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),
//                PackageItem = new PhysicalItem("v_ret_ml_cigs3",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -10 },
...
//                ModelItem = new PhysicalItem("ng_proc_cigarette01a",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),
//                PackageItem = new PhysicalItem("v_ret_ml_cigs4",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -10 },
//            new ModItem("Caradique", "Fine Napoleon Cigarettes",eConsumableType.Smoke) {
//                ModelItem = new PhysicalItem("ng_proc_cigarette01a",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),
//                PackageItem = new PhysicalItem("v_ret_ml_cigs5",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -10 },
//            new ModItem("69 Brand","Don't let an embargo stop you",eConsumableType.Smoke) {
//                ModelItem = new PhysicalItem("ng_proc_cigarette01a",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),
//                PackageItem = new PhysicalItem("v_ret_ml_cigs6",57005, new Vector3(0.14f, 0.03f, 0.0f),new Rotator(0.49f, 79f, 79f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -10 },
...
//                ModelItem = new PhysicalItem("prop_cigar_02",57005, new Vector3(0.17f, 0.02f, 0.0f),new Rotator(0.0f, -78f, 0f)),
//                PackageItem = new PhysicalItem("p_cigar_pack_02_s",57005, new Vector3(0.17f, 0.02f, 0.0f),new Rotator(0.0f, -78f, 0f)),AmountPerPackage = 20, RequiredToolType = ToolTypes.Lighter, HealthChangeAmount = -5 },
...
//                ModelItem = new PhysicalItem("prop_food_juice01",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)), HealthChangeAmount = 10 },

//            //BurgerShot
//            new ModItem("Money Shot Meal",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_bs_burg1",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f))
//                ,PackageItem = new PhysicalItem("prop_food_bs_tray_02"), HealthChangeAmount = 12, ConsumeOnPurchase = true},
//            new ModItem("The Bleeder Meal","",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_bs_burg1",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f))
//                ,PackageItem = new PhysicalItem("prop_food_bs_tray_02"), HealthChangeAmount = 20, ConsumeOnPurchase = true},
//            new ModItem("Torpedo Meal","Torpedo your hunger",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_bs_burger2",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f))
//                ,PackageItem = new PhysicalItem("prop_food_bs_tray_03"), HealthChangeAmount = 15, ConsumeOnPurchase = true},
//            new ModItem("Meat Free Meal","For the bleeding hearts",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_bs_burger2",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f))
//                ,PackageItem = new PhysicalItem("prop_food_bs_tray_01"), HealthChangeAmount = 5, ConsumeOnPurchase = true},
//            new ModItem("Freedom Fries",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_bs_chips",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)), HealthChangeAmount = 5 },
//            new ModItem("Double Shot Coffee",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_food_bs_coffee",57005,new Vector3(0.07f, -0.1f, -0.1f),new Rotator(-74.0f, 28.0f, 3.0f)), HealthChangeAmount = 5 },
//            new ModItem("Liter of eCola",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_food_bs_juice01",57005,new Vector3(0.07f, -0.1f, -0.1f),new Rotator(-74.0f, 28.0f, 3.0f)), HealthChangeAmount = 5 },
//            new ModItem("Liter of Sprunk",eConsumableType.Drink) {
//                ModelItem = new PhysicalItem("prop_food_bs_juice01",57005,new Vector3(0.07f, -0.1f, -0.1f),new Rotator(-74.0f, 28.0f, 3.0f)), HealthChangeAmount = 5 },

//            //Bite
//            new ModItem("Gut Buster Sandwich",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_burg2",57005,new Vector3(0.14f, 0.01f, -0.06f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 10 } ,
//            new ModItem("Ham and Tuna Sandwich",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_burg2",57005,new Vector3(0.14f, 0.01f, -0.06f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 10 } ,
//            new ModItem("Chef's Salad",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 5, ConsumeOnPurchase = true} ,

//            //BeefyBills
//            new ModItem("Megacheese Burger",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_cs_burger_01",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)), HealthChangeAmount = 10 },
//            new ModItem("Double Burger",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_cs_burger_01",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)), HealthChangeAmount = 12 },
//            new ModItem("Kingsize Burger",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_cs_burger_01",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)), HealthChangeAmount = 15 },
//            new ModItem("Bacon Burger",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_cs_burger_01",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)), HealthChangeAmount = 17 },

//            //Taco Bomb
//            new ModItem("Breakfast Burrito",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_bs_burger2",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f))
//                ,PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 12, ConsumeOnPurchase = true},
//            new ModItem("Deep Fried Salad",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 10, ConsumeOnPurchase = true},
//            new ModItem("Beef Bazooka",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_bs_burger2",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f))
//                ,PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 15, ConsumeOnPurchase = true},
//            new ModItem("Chimichingado Chiquito",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 10, ConsumeOnPurchase = true},
//            new ModItem("Cheesy Meat Flappers",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 10, ConsumeOnPurchase = true},
...
//            //CB
//            new ModItem("Cluckin' Little Meal","May contain meat",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_cb_tray_03"), HealthChangeAmount = 5, ConsumeOnPurchase = true },
//            new ModItem("Cluckin' Big Meal","200% bigger breasts",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_cb_tray_02"), HealthChangeAmount = 10, ConsumeOnPurchase = true } ,
//            new ModItem("Cluckin' Huge Meal",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_cb_tray_02"), HealthChangeAmount = 15, ConsumeOnPurchase = true } ,
//            new ModItem("Wing Piece",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_cb_tray_03"), HealthChangeAmount = 10, ConsumeOnPurchase = true },
//            new ModItem("Little Peckers",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_cb_tray_03"), HealthChangeAmount = 5 , ConsumeOnPurchase = true},
//            new ModItem("Balls & Rings",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_burg3",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 5, ConsumeOnPurchase = true },
//            new ModItem("Fowlburger",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_food_burg1",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)),
//                PackageItem = new PhysicalItem("prop_food_burg3"), HealthChangeAmount = 10 } ,

//            //Bean Machine
//            new ModItem("High Noon Coffee","Drip coffee, carbonated water, fruit syrup and taurine.",eConsumableType.Drink) {
//               ModelItem = new PhysicalItem("p_ing_coffeecup_01",57005,new Vector3(0.12f, -0.06f, -0.08f),new Rotator(-78.0f, 0.0f, 0.0f)), HealthChangeAmount = 10 },
...
//               ModelItem = new PhysicalItem("p_ing_coffeecup_01",57005,new Vector3(0.12f, -0.06f, -0.08f),new Rotator(-78.0f, 0.0f, 0.0f)), HealthChangeAmount = 12 },
//            new ModItem("Speedball Coffee","Caffeine tripe-shot, guarana, bat guano, and mate.",eConsumableType.Drink) {
//               ModelItem = new PhysicalItem("p_ing_coffeecup_01",57005,new Vector3(0.12f, -0.06f, -0.08f),new Rotator(-78.0f, 0.0f, 0.0f)), HealthChangeAmount = 15 },
...
//               ModelItem = new PhysicalItem("p_ing_coffeecup_01",57005,new Vector3(0.12f, -0.06f, -0.08f),new Rotator(-78.0f, 0.0f, 0.0f)), HealthChangeAmount = 17 },
//            new ModItem("Bratte Coffee","Double shot latte, and 100 pumps of caramel.",eConsumableType.Drink) {
//               ModelItem = new PhysicalItem("p_ing_coffeecup_01",57005,new Vector3(0.12f, -0.06f, -0.08f),new Rotator(-78.0f, 0.0f, 0.0f)), HealthChangeAmount = 5 },
...
//            //Viceroy
//            new ModItem("City View King","Standard room with a view of the city",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },
//            new ModItem("City View Deluxe King","Deluxe room with view of the city.",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },
//            //new ModItem("Partial Ocean View King","Standard room with a partial view of the ocean.",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },
//            new ModItem("Ocean View King","Standard room a full view of the ocean. ",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },
//           // new ModItem("City View Two Bedded Room","Standard room with a view of the city",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },
//            new ModItem("Grande King","XL Deluxe room with plenty of space and amenities.",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },
//            new ModItem("Grande Ocean View King","XL Deluxe room with with plenty of space and amenities and a view of the ocean",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },
//           // new ModItem("Empire Suite","",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },
//            new ModItem("Monarch Suite","Penthouse suite, reserved for the most discerning tastes",eConsumableType.Service, ItemType.Service) {ConsumeOnPurchase = true, MeasurementName = "Night" },

//            //Generic
//            //FancyDeli
//            new ModItem("Chicken Club Salad",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 20, ConsumeOnPurchase = true } ,
//            new ModItem("Spicy Seafood Gumbo",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 20, ConsumeOnPurchase = true } ,
//            new ModItem("Muffaletta",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 20, ConsumeOnPurchase = true } ,
...
//            //FancyGeneric
//            new ModItem("Smokehouse Burger",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_cs_burger_01",57005,new Vector3(0.16f, 0.01f, -0.04f),new Rotator(0.0f, 28.0f, 0.0f)), HealthChangeAmount = 20, ConsumeOnPurchase = true },
//            new ModItem("Chicken Critters Basket",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 20, ConsumeOnPurchase = true } ,
//            new ModItem("Prime Rib 16 oz",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 20, ConsumeOnPurchase = true } ,
//            new ModItem("Bone-In Ribeye",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_cs_steak"), HealthChangeAmount = 20, ConsumeOnPurchase = true } ,
//            new ModItem("Grilled Pork Chops",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_bag1"), HealthChangeAmount = 20, ConsumeOnPurchase = true } ,
//            new ModItem("Grilled Shrimp",eConsumableType.Eat, ItemType.Food) {
//                PackageItem = new PhysicalItem("prop_food_bag1") , HealthChangeAmount = 20, ConsumeOnPurchase = true } ,
...
//            //Noodles
//            new ModItem("Juek Suk tong Mandu",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_ff_noodle_01",57005,new Vector3(0.0f, 0.0f, 0.0f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 10 },
//            new ModItem("Hayan Jam Pong",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_ff_noodle_02",57005,new Vector3(0.0f, 0.0f, 0.0f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 15 } ,
//            new ModItem("Sal Gook Su Jam Pong",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_ff_noodle_01",57005,new Vector3(0.0f, 0.0f, 0.0f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 20 } ,
//            new ModItem("Chul Pan Bokkeum Jam Pong",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_ff_noodle_02",57005,new Vector3(0.0f, 0.0f, 0.0f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 20 } ,
//            new ModItem("Deul Gae Udon",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_ff_noodle_02",57005,new Vector3(0.0f, 0.0f, 0.0f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 20 } ,
//            new ModItem("Dakgogo Bokkeum Bap",eConsumableType.Eat, ItemType.Food) {
//                ModelItem = new PhysicalItem("prop_ff_noodle_01",57005,new Vector3(0.0f, 0.0f, 0.0f),new Rotator(0f, 0f, 0f)), HealthChangeAmount = 20 } ,
