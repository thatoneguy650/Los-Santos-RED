...
public class ModItems : IModItems
{
    ...
    private void DefaultConfig_Drinks()
    {
        PossibleItems.DrinkItems.AddRange(new List<DrinkItem> {
            ...
            new DrinkItem("Can of Blarneys", "Making your mouth feel lucky", ItemType.Drinks) { IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5, SleepChangeAmount = -2.0f,HungerChangeAmount = 2.0f,ThirstChangeAmount = 5.0f, },
            new DrinkItem("Can of Logger", "A classic American tasteless, watery beer, made by Rednecks for Rednecks. Now Chinese owned", ItemType.Drinks) { IntoxicantName = "Low Proof Alcohol",HealthChangeAmount = 5, SleepChangeAmount = -2.0f,HungerChangeAmount = 2.0f,ThirstChangeAmount = 5.0f, },
            //Bean Machine
    ...
    private void DefaultConfig_Drugs()
    {
        ...
        PossibleItems.IngestItems.AddRange(new List<IngestItem>
        {
            ...
            new IngestItem("Equanox","Combats dissatisfaction, lethargy, depression, melancholy, sexual dysfunction. Equanox may cause nausea, loss of sleep, blurred vision, leakage, kidney problems and breathing irregularities.", ItemType.Drugs) {
