    ...
    private void DefaultConfig()
    {
        ModItemsList = new List<ModItem>
        {
            ...
            new ModItem("Bottle of Raine Water","The water that rich people drink, and the main reason why there are now entire continents of plastic bottles floating in the ocean",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("ba_prop_club_water_bottle",18905,new Vector3(0.11f, -0.05f, 0.03f),new Rotator(-99.0f, 14.0f, 1.0f)), HealthChangeAmount = 20 },//slight clipping, no issyes
            ...
            new ModItem("Bottle of GREY Water","Expensive water that tastes worse than tap!",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("h4_prop_battle_waterbottle_01a",18905,new Vector3(0.11f, -0.05f, 0.03f),new Rotator(-99.0f, 14.0f, 1.0f)), HealthChangeAmount = 20,CleanupItemImmediately = true },//lotsa clipping, does not have gravity

            new ModItem("Bottle of 40 oz","Drink like a true thug!",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_cs_beer_bot_40oz",18905,new Vector3(0.11f, -0.05f, 0.03f),new Rotator(-99.0f, 14.0f, 1.0f)), IntoxicantName = "Low Proof Alcohol" },
            new ModItem("Bottle of JUNK Energy", "The Quick Fix!",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_energy_drink",18905,new Vector3(0.11f, -0.05f, 0.03f),new Rotator(-99.0f, 14.0f, 1.0f)) , HealthChangeAmount = 30},//fine
            ...
            new ModItem("Bottle of PiBwasser","Cheap 11% ABV fighting lager brewed in Germany for export only from rice, barley, hops and the fresh urine of Bavarian virgins",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_amb_beer_bottle",18905,new Vector3(0.11f, -0.05f, 0.03f),new Rotator(-99.0f, 14.0f, 1.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5 },//is perfecto


            new ModItem("Bottle of A.M.","Mornings Golden Shower",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_beer_am",18905,new Vector3(0.11f, -0.18f, 0.08f),new Rotator(-109.0f, 3.0f, -4.0f)), IntoxicantName = "Low Proof Alcohol" , HealthChangeAmount = 5,CleanupItemImmediately = true},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Barracho","Es Playtime!",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_beer_bar",18905,new Vector3(0.11f, -0.18f, 0.08f),new Rotator(-109.0f, 3.0f, -4.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5,CleanupItemImmediately = true},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Blarneys","Making your mouth feel lucky",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_beer_blr",18905,new Vector3(0.11f, -0.18f, 0.08f),new Rotator(-109.0f, 3.0f, -4.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5,CleanupItemImmediately = true },//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Jakeys","Drink Outdoors With Jakey's",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_beer_jakey",18905,new Vector3(0.11f, -0.18f, 0.08f),new Rotator(-109.0f, 3.0f, -4.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5,CleanupItemImmediately = true},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Logger","A classic American tasteless, watery beer, made by Rednecks for Rednecks. Now Chinese owned",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_beer_logger",18905,new Vector3(0.11f, -0.18f, 0.08f),new Rotator(-109.0f, 3.0f, -4.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5,CleanupItemImmediately = true},//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Patriot","Never refuse a patriot",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_beer_patriot",18905,new Vector3(0.11f, -0.18f, 0.08f),new Rotator(-109.0f, 3.0f, -4.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5,CleanupItemImmediately = true },//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Pride","Swallow Me",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_beer_pride",18905,new Vector3(0.11f, -0.18f, 0.08f),new Rotator(-109.0f, 3.0f, -4.0f)),IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5,CleanupItemImmediately = true },//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Stronzo","Birra forte d'Italia",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_beer_stz",18905,new Vector3(0.11f, -0.18f, 0.08f),new Rotator(-109.0f, 3.0f, -4.0f)),IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5,CleanupItemImmediately = true },//Does not have gravity, attachmentis too far down
            new ModItem("Bottle of Dusche","Das Ist Gut Ja!",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_beerdusche",18905,new Vector3(0.11f, -0.18f, 0.08f),new Rotator(-109.0f, 3.0f, -4.0f)), IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5,CleanupItemImmediately = true},//Does not have gravity, attachmentis too far down


            new ModItem("Bottle of Sinsimito Tequila","Extra Anejo 100% De Agave. 42% Alcohol by volume",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("h4_prop_h4_t_bottle_02a",18905,new Vector3(0.11f, -0.05f, 0.03f),new Rotator(-99.0f, 14.0f, 1.0f)), IntoxicantName = "High Proof Alcohol", HealthChangeAmount = 15},
            new ModItem("Bottle of Cazafortuna Tequila","Tequila Anejo. 100% Blue Agave 40% Alcohol by volume",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("h4_prop_h4_t_bottle_01a",18905,new Vector3(0.11f, -0.05f, 0.03f),new Rotator(-99.0f, 14.0f, 1.0f)), IntoxicantName = "High Proof Alcohol", HealthChangeAmount = 15},
            ...
            new ModItem("Can of eCola", "Deliciously Infectious!",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("ng_proc_sodacan_01a",18905,new Vector3(0.12f, -0.07f, 0.07f),new Rotator(-110.0f, 14.0f, 1.0f)) , HealthChangeAmount = 10},
            new ModItem("Can of Sprunk", "Slurp Sprunk Mmm! Delicious",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("ng_proc_sodacan_01b",18905,new Vector3(0.12f, -0.07f, 0.07f),new Rotator(-110.0f, 14.0f, 1.0f)), HealthChangeAmount = 10 },
            new ModItem("Can of Orang-O-Tang", "Orange AND Tang! Orang-O-Tang!",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("prop_orang_can_01",18905,new Vector3(0.13f, 0.01f, 0.02f),new Rotator(-110.0f, 16.0f, 0.0f)), HealthChangeAmount = 10 },//needs better attachment
            ...
            new ModItem("Cup of eCola", "Deliciously Infectious!",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("ng_proc_sodacup_01a",18905,new Vector3(0.09f, -0.18f, 0.11f),new Rotator(-104.0f, 14.0f, 3.0f)), HealthChangeAmount = 10 },//has no gravity, too far down
            new ModItem("Cup of Sprunk", "Slurp Sprunk Mmm! Delicious",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("ng_proc_sodacup_01b",18905,new Vector3(0.09f, -0.18f, 0.11f),new Rotator(-104.0f, 14.0f, 3.0f)), HealthChangeAmount = 10 },//perfecto
            new ModItem("Cup of Coffee","Finally something without sugar! Sugar on Request",eConsumableType.Drink) {
               ModelItem = new PhysicalItem("p_ing_coffeecup_02",18905,new Vector3(0.14f, 0.01f, 0.03f),new Rotator(-110.0f, 13.0f, 0.0f)), HealthChangeAmount = 10 },//perfecto
            ...
            new ModItem("Can of Blarneys","Making your mouth feel lucky",eConsumableType.Drink) { IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5 },
            new ModItem("Can of Logger","A classic American tasteless, watery beer, made by Rednecks for Rednecks. Now Chinese owned",eConsumableType.Drink) { IntoxicantName = "Low Proof Alcohol", HealthChangeAmount = 5},


            //Bean Machine
            new ModItem("High Noon Coffee","Drip coffee, carbonated water, fruit syrup and taurine.",eConsumableType.Drink) {
               ModelItem = new PhysicalItem("p_ing_coffeecup_01",18905,new Vector3(0.14f, 0.01f, 0.03f),new Rotator(-110.0f, 13.0f, 0.0f)), HealthChangeAmount = 10 },//perfecto
            new ModItem("The Eco-ffee","Decaf light, rain forest rain, saved whale milk, chemically reclaimed freerange organic tofu, and recycled brown sugar",eConsumableType.Drink) {
               ModelItem = new PhysicalItem("p_ing_coffeecup_01",18905,new Vector3(0.14f, 0.01f, 0.03f),new Rotator(-110.0f, 13.0f, 0.0f)), HealthChangeAmount = 12 },//perfecto
            new ModItem("Speedball Coffee","Caffeine tripe-shot, guarana, bat guano, and mate.",eConsumableType.Drink) {
               ModelItem = new PhysicalItem("p_ing_coffeecup_01",18905,new Vector3(0.14f, 0.01f, 0.03f),new Rotator(-110.0f, 13.0f, 0.0f)), HealthChangeAmount = 15 },//perfecto
            ...
            new ModItem("Bratte Coffee","Double shot latte, and 100 pumps of caramel.",eConsumableType.Drink) {
               ModelItem = new PhysicalItem("p_ing_coffeecup_01",18905,new Vector3(0.14f, 0.01f, 0.03f),new Rotator(-110.0f, 13.0f, 0.0f)), HealthChangeAmount = 5 },//perfecto
            ...
            new ModItem("Jumbo Shake", "Almost a whole cow full of milk", eConsumableType.Drink) {
                ModelItem = new PhysicalItem("ng_proc_sodacup_01c",18905,new Vector3(0.09f, -0.18f, 0.11f),new Rotator(-104.0f, 14.0f, 3.0f)), HealthChangeAmount = 10 },//no gravity, attached wrong


        //burger shot
            new ModItem("Double Shot Coffee",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("p_ing_coffeecup_01",18905,new Vector3(0.14f, 0.01f, 0.03f),new Rotator(-110.0f, 13.0f, 0.0f)), HealthChangeAmount = 5 },//n gravity,not attached right
            new ModItem("Liter of eCola",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("ng_proc_sodacup_01a",18905,new Vector3(0.09f, -0.18f, 0.11f),new Rotator(-104.0f, 14.0f, 3.0f)), HealthChangeAmount = 5 },//n gravity,not attached right
            new ModItem("Liter of Sprunk",eConsumableType.Drink) {
                ModelItem = new PhysicalItem("ng_proc_sodacup_01b",18905,new Vector3(0.09f, -0.18f, 0.11f),new Rotator(-104.0f, 14.0f, 3.0f)), HealthChangeAmount = 5 },//n gravity,not attached right
            ...
            new ModItem("Hot Sausage","Get all your jokes out",eConsumableType.Eat) {
                ModelItem = new PhysicalItem("prop_cs_hotdog_01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 10 },
            new ModItem("Hot Pretzel","You tie me up",eConsumableType.Eat) {HealthChangeAmount = 10 },
            new ModItem("3 Mini Pretzels","Like a pretzel, but smaller",eConsumableType.Eat) {HealthChangeAmount = 10 },
            new ModItem("Nuts","You're gonna love my nuts",eConsumableType.Eat) {HealthChangeAmount = 10 },
           ...
           // 18905,new Vector3(0.12f, -0.07f, 0.07f),new Rotator(-110.0f, 14.0f, 1.0f))
            ...
            new ModItem("Tuna Sandwich","Haven't got enough heavy metals in you at your job? Try tuna!",eConsumableType.Eat) {
                ModelItem = new PhysicalItem("prop_sandwich_01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)), HealthChangeAmount = 10 } ,
            new ModItem("Taco",eConsumableType.Eat) { HealthChangeAmount = 10 },
            new ModItem("Strawberry Rails Cereal","The breakfast food you snort!",eConsumableType.Eat) { HealthChangeAmount = 50,
                //ModelItem = new PhysicalItem("v_res_tt_cereal01",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)),  
            } ,
            new ModItem("Crackles O' Dawn Cereal","Smile at the crack!",eConsumableType.Eat) { HealthChangeAmount = 60,
                //ModelItem = new PhysicalItem("v_res_tt_cereal02",57005,new Vector3(0.14f, -0.02f, -0.04f),new Rotator(178.0f, 28.0f, 0.0f)),  
            } ,
            new ModItem("White Bread","Extra white, with minimal taste.",eConsumableType.Eat) { HealthChangeAmount = 10, AmountPerPackage = 25,
