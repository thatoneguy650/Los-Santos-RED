...
public class ModItems : IModItems
{
	...
	<PropModel modelName="prop_food_tray_03" modelHash="0xafe36543" />
        ...
        new ModItem("Benefactor Schafter V12", true) { ModelItem = new PhysicalItem("schafter3") { Type = ePhysicalItemType.Vehicle }},
        new ModItem("Benefactor Schafter LWB", true) { ModelItem = new PhysicalItem("schafter4") { Type = ePhysicalItemType.Vehicle }},
