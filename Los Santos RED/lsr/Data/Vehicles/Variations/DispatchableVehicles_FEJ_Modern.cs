...
public class DispatchableVehicles_FEJ_Modern
{
    ...
    private void LocalPolice()
    {
        UnmarkedVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(5,5,-1,true,PoliceVehicleType.Unmarked,-1,-1,-1,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(5,5,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"",""),
        ...
        LSPDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(2,2,1,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,3,-1,-1,"",""),
        ...
        EastLSPDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(2,2,2,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,3,-1,-1,"",""),
        ...
        VWPDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(2,2,3,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,3,-1,-1,"",""),
        ...
        RHPDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(5,5,7,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,3,-1,-1,"",""),
        ...
        DPPDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(3,3,8,false,PoliceVehicleType.MarkedFlatLightbar,-1,-1,3,-1,-1,"",""),
    ...
    private void StatePolice()
    {
        ...
        LSIAPDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(2,2,13,false,PoliceVehicleType.MarkedFlatLightbar,-1,-1,-1,-1,-1,"",""),
        ...
        LSPPVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceAleutian(5,5,14,false,PoliceVehicleType.MarkedFlatLightbar,-1,-1,-1,-1,-1,"",""),
        ...
        SAHPVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(2,2,4,false,PoliceVehicleType.Marked,-1,-1,3,-1,-1,"","",0),
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(2,2,4,false,PoliceVehicleType.SlicktopMarked,-1,-1,3,-1,-1,"","",0),
    ...
    private void LocalSheriff()
    {
        ...
        DispatchableVehicle BCSOCavalcadeK9 = DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(0, 5, 21, false, PoliceVehicleType.MarkedValorLightbar, -1, -1, 3, -1, -1, "", "");
        BCSOCavalcadeK9.CaninePossibleSeats = new List<int> { 1 };
        BCSOCavalcadeK9.SpawnAdjustmentAmounts = new List<SpawnAdjustmentAmount>() { new SpawnAdjustmentAmount(eSpawnAdjustment.K9, 10) };
        ...
        BCSOVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(3,3,0,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,3,-1,-1,"","",-1,45),
        ...
        BCSOPaletoVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(50,50,6,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,3,-1,-1,"","",-1,45),
        ...
        LSSDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(2,2,9,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,3,-1,-1,"","",-1,45),
        ...
        MajesticLSSDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(3,3,10,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,3,-1,-1,"","",-1,45),
        ...
        VWHillsLSSDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(3,3,12,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,3,-1,-1,"","",-1,45),
            LSSDGresleyK9,
            LSSDGranger3600K9,
            LSSDScoutK9,
        ...
        DavisLSSDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PolicePurge(5,5,5,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,3,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(1,1,11,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,3,-1,-1,"",""),
            LSSDGresleyK9,
            LSSDGranger3600K9,
            LSSDScoutK9,
    ...
    private void FederalPolice()
    {
        FIBVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(25,25,-1,false,PoliceVehicleType.Unmarked,1,0,3,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(25,25,-1,false,PoliceVehicleType.Detective,1,0,3,-1,-1,"",""),
           ...
           // new DispatchableVehicle(DispatchableVehicles_FEJ.PoliceMaverick, 0, 30) { MinWantedLevelSpawn = 5, MaxWantedLevelSpawn = 5,RequiredPrimaryColorID = 1,RequiredSecondaryColorID = 1, RequiredPedGroup = "FIBHET",MinOccupants = 3, MaxOccupants = 4, RequiredLiveries = new List<int>() { 3 } },
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(0,25,-1,false,PoliceVehicleType.Detective,1,5,5,3,4,"FIBHET",""),
        ...
        MarshalsServiceVehicles_FEJ_Modern = new List<DispatchableVehicle>
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(15, 15, -1, true, PoliceVehicleType.Unmarked, -1, -1, -1, -1, -1, "", ""),
        ...
        DOAVehicles_FEJ_Modern = new List<DispatchableVehicle>
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceGranger3600(15, 15, -1, true, PoliceVehicleType.Unmarked, -1, -1, -1, -1, -1, "", ""),
            DispatchableVehicles_FEJ.Create_PoliceAleutian(15, 15, -1, true, PoliceVehicleType.Unmarked, -1, -1, -1, -1, -1, "", ""),
            DispatchableVehicles_FEJ.Create_PoliceCavalcadeXL(2, 2, -1, true, PoliceVehicleType.Unmarked, -1, -1, -1, -1, -1, "", ""),
            DispatchableVehicles_FEJ.Create_PoliceVSTR(15, 15, 2, true, PoliceVehicleType.Unmarked, -1, -1, -1, -1, -1, "", ""),
            DispatchableVehicles_FEJ.Create_PoliceStanier(5, 5, -1, true, PoliceVehicleType.Unmarked, -1, -1, -1, -1, -1, "", "", -1,0),
            //DispatchableVehicles_FEJ.Create_PoliceReblaGTS(1,1,3,true,PoliceVehicleType.Unmarked,-1,-1,-1,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceRiata(2,2,7,true,PoliceVehicleType.Unmarked,-1,-1,-1,1,2,"","",4),
