...
public class DispatchableVehicles_FEJ_Modern
{
    ...
    private void LocalPolice()
    {
        UnmarkedVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(25,25,-1,true,PoliceVehicleType.Unmarked,-1,-1,-1,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(25,25,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"",""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceBuffaloS(2, 2, -1, true, PoliceVehicleType.Unmarked, -1, -1, -1, -1, -1, "", ""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceRadius(5,5,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"",""),
        ...
        LSPDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceLandstalkerXL(1,1,1,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceCaracara(2,2,1,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceBuffaloS(3,3,1,false, PoliceVehicleType.Marked, -1, -1, -1, -1, -1, "", ""),
            DispatchableVehicles_FEJ.Create_PoliceStanier(9,9,1,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceFugitive(4,4,1,false,PoliceVehicleType.Marked,-1,-1,-1,-1,-1,"",""),                   
            ...
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(1,1,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"Detective",""),
        ...
        EastLSPDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(30,30,3,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceRadius(10,10,3,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(10,10,3,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
        ...
        VWPDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(5,5,2,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(1,1,-1,true,PoliceVehicleType.Unmarked,-1,-1,-1,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(1,1,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"Detective",""),
            DispatchableVehicles_FEJ.Create_PoliceGresley(1,1,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"Detective",""),
            DispatchableVehicles_FEJ.Create_PoliceGranger3600(1,1,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"Detective",""),
            DispatchableVehicles_FEJ.Create_PoliceAleutian(1,1,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"Detective",""),
        ...
        RHPDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceRaiden(10,10,10,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),

            DispatchableVehicles_FEJ.Create_PoliceBuffaloS(5, 5, 5, false, PoliceVehicleType.Marked, -1, -1, -1, -1, -1, "", ""),
            DispatchableVehicles_FEJ.Create_PoliceRadius(15,15,5,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(5,5,5,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
        ...
        {       
            ...
            DispatchableVehicles_FEJ.Create_PoliceRadius(15,15,6,false,PoliceVehicleType.MarkedFlatLightbar,-1,-1,-1,-1,-1,"",""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(10,10,8,false,PoliceVehicleType.MarkedFlatLightbar,-1,-1,-1,-1,-1,"",""),
    ...
    private void StatePolice()
    {
        ...
        {           
            DispatchableVehicles_FEJ.Create_PoliceStanier(5,5,16,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),//OLD LIVERY

            DispatchableVehicles_FEJ.Create_PoliceBison(5,5,16,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),//NEW LIVERY
        ...
        LSIAPDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceRadius(25,25,12,false,PoliceVehicleType.MarkedFlatLightbar,-1,-1,-1,-1,-1,"",""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(12,12,12,false,PoliceVehicleType.MarkedFlatLightbar,-1,-1,-1,-1,-1,"",""),
        };
        LSPPVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(10,10,13,false,PoliceVehicleType.MarkedFlatLightbar,-1,-1,-1,-1,-1,"",""),
        ...
        SAHPVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(1,1,-1,true,PoliceVehicleType.Unmarked,-1,-1,-1,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(1,1,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"",""),
        ...
        {
            DispatchableVehicles_FEJ.Create_PoliceStanier(50,50,14,false,PoliceVehicleType.MarkedOriginalLightbar,134,-1,-1,-1,-1,"",""),        
    ...
    private void LocalSheriff()
    {
        BCSOVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceRadius(7,7,0,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceStanier(10,10,0,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
        ...
        LSSDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(15,15,7,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceLandstalkerXL(1,1,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"Detective",""),
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(1,1,-1,true,PoliceVehicleType.Unmarked,-1,-1,-1,-1,-1,"Detective",""),
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(1,1,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"Detective",""),
            DispatchableVehicles_FEJ.Create_PoliceBison(1,1,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"Detective",""),
            DispatchableVehicles_FEJ.Create_PoliceFugitive(1,1,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"Detective",""),
            DispatchableVehicles_FEJ.Create_PoliceBuffaloSTX(1,1,-1,true,PoliceVehicleType.Detective,-1,-1,-1,-1,-1,"Detective",""),
        ...
        MajesticLSSDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(10,10,8,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
        ...
        VWHillsLSSDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(5,5,9,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
        ...
        DavisLSSDVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(35,35,10,false,PoliceVehicleType.MarkedNewSlicktop,-1,-1,-1,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceRadius(15,15,10,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceRadius(15,15,10,false,PoliceVehicleType.MarkedNewSlicktop,-1,-1,-1,-1,-1,"",""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(20,20,10,false,PoliceVehicleType.MarkedValorLightbar,-1,-1,-1,-1,-1,"",""),

            DispatchableVehicles_FEJ.Create_PoliceStanier(20,20,10,false,PoliceVehicleType.SlicktopMarked,-1,-1,-1,-1,-1,"",""),
    ...
    {   
        FIBVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(25,25,-1,true,PoliceVehicleType.Unmarked,1,0,4,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(25,25,-1,true,PoliceVehicleType.Detective,1,0,4,-1,-1,"",""),
            ...
            DispatchableVehicles_FEJ.Create_PoliceRadius(5,5,-1,false,PoliceVehicleType.Unmarked,1,0,3,-1,-1,"",""),
            DispatchableVehicles_FEJ.Create_PoliceRadius(5,5,-1,false,PoliceVehicleType.Detective,1,0,3,-1,-1,"",""),
           ...
           // new DispatchableVehicle(DispatchableVehicles_FEJ.PoliceMaverick, 0, 30) { MinWantedLevelSpawn = 5, MaxWantedLevelSpawn = 5,RequiredPrimaryColorID = 1,RequiredSecondaryColorID = 1, RequiredPedGroup = "FIBHET",MinOccupants = 3, MaxOccupants = 4, RequiredLiveries = new List<int>() { 3 } },
            ...
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(0,25,-1,true,PoliceVehicleType.Detective,1,5,5,3,4,"FIBHET",""),
        ...
        BorderPatrolVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(1,1,19,false,PoliceVehicleType.MarkedFlatLightbar,134,-1,-1,-1,-1,"",""),
        ...
        NOOSEPIAVehicles_FEJ_Modern = new List<DispatchableVehicle>()
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceStanier(1,1,17,false,PoliceVehicleType.MarkedFlatLightbar,134,0,3,-1,-1,"",""),
        ...
        MarshalsServiceVehicles_FEJ_Modern = new List<DispatchableVehicle>
        {
            ...
            DispatchableVehicles_FEJ.Create_PoliceInterceptor(35, 35, -1, true, PoliceVehicleType.Unmarked, -1, -1, -1, -1, -1, "", ""),
            DispatchableVehicles_FEJ.Create_PoliceLandstalkerXL(20, 20, -1, true, PoliceVehicleType.Unmarked, -1, -1, -1, -1, -1, "", ""),
