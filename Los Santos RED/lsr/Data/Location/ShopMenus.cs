    ...
    private void DefaultConfig()
    {
        ShopMenuList = new List<ShopMenu>()
        {
            ...
            new ShopMenu("VapidMenu","Vapid",new List<MenuItem>() {
                ...
                new MenuItem("Vapid Caracara*",60000),
