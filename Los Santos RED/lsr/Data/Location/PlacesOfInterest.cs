...
public class PlacesOfInterest : IPlacesOfInterest
{
    ...
    private void DefaultConfig_DriveThrus()
    {
        DriveThrus = new List<DriveThru>()
        {
            ...
            new DriveThru(new Vector3(15.48935f, -1595.832f, 29.28254f), 319.2816f, "The Taco Farmer", "Open All Hours!","TacoFarmerMenu") { BannerImagePath = "tacofarmer.png" },
            new DriveThru(new Vector3(-576.9321f, -880.5195f, 25.70123f), 86.01214f, "Lucky Plucker", "Come be a real Lucky Plucker","LuckyPluckerMenu") { BannerImagePath = "luckyplucker.png",ScannerFilePath = "01_specific_location\\0x14B8A4DB.wav" } ,
            new DriveThru(new Vector3(2591.213f, 478.8892f, 108.6423f), 270.9569f, "Bishop's Chicken", "Our chicken is a religious experience","BishopsChickenMenu") { BannerImagePath = "bishops.png" },
            new DriveThru(new Vector3(144.34f, -1541.275f, 28.36799f), 139.819f, "La Vaca Loca", "Whats wrong with a few mad cows?","LaVacaLocaMenu"){ BannerImagePath = "vacaloca.png" },
            new DriveThru(new Vector3(145.3499f, -1460.568f, 28.71129f), 49.75111f,  "Lucky Plucker", "Come be a real Lucky Plucker","LuckyPluckerMenu") { BannerImagePath = "luckyplucker.png" },
            new DriveThru(new Vector3(1256.509f, -357.1387f, 68.52029f), 347.8622f, "Horny's Burgers", "The beef with the bone!","HornysBurgersMenu"){ BannerImagePath = "hornys.png" },
    ...
    private void DefaultConfig_Dealerships()
    {
        Dealerships = new List<Dealership>()
        {
            new Dealership(new Vector3(-69.16984f, 63.42498f, 71.89044f), 150.3918f, "Benefactor/Gallivanter", "Take control","BenefactorGallavanterMenu") { 
                BannerImagePath = "benefactorgallivanter.png",
                LicensePlatePreviewText = "BENE GALA",
                AssignedAssociationID = "BOBCAT",
                PossiblePedSpawns = new List<ConditionalLocation>() { new ConditionalLocation(new Vector3(-72.16306f, 64.89938f, 71.84079f), 150.1162f, 100f) { TaskRequirements = TaskRequirements.Guard | TaskRequirements.StandardScenario, RequiredPedGroup = "UnarmedSecurity" } },
                PossibleVehicleSpawns = new List<ConditionalLocation>() { new ConditionalLocation(new Vector3(-97.9782f, 84.38512f, 71.20057f), 149.9098f, 75f), },
            ...
            new Dealership(new Vector3(-802.8875f, -223.7307f, 37.21824f), 117.6851f, "Luxury Autos", "You sure you can afford this?","LuxuryAutosMenu") {
                BannerImagePath = "luxuryautos.png",
                VehiclePreviewLocation = new SpawnPlace(new Vector3(226.205f, -992.613f, -98.99996f), 177.2006f),
                LicensePlatePreviewText = "LUX AUTO",
                AssignedAssociationID = "MERRY",
                PossiblePedSpawns = new List<ConditionalLocation>() {
                    new ConditionalLocation(new Vector3(-802.0759f, -227.486f, 37.19593f), 120.1107f, 75f) { TaskRequirements = TaskRequirements.Guard | TaskRequirements.StandardScenario, RequiredPedGroup = "UnarmedSecurity" },
                    new ConditionalLocation(new Vector3(-805.9191f, -220.9726f, 37.25732f), 121.415f, 75f) { TaskRequirements = TaskRequirements.Guard | TaskRequirements.StandardScenario, RequiredPedGroup = "UnarmedSecurity" },
                },
                PossibleVehicleSpawns = new List<ConditionalLocation>()
                { 
                    new ConditionalLocation(new Vector3(-811.8248f, -220.6809f, 36.87595f), 27.60655f, 65f) { },
                    new ConditionalLocation(new Vector3(-804.566f, -235.1782f, 36.70311f), 29.39835f, 35f) {IsEmpty = false, RequiredPedGroup = "UnarmedSecurity" }, },
                VehicleDeliveryLocations = new List<SpawnPlace>() {
            ...
            new Dealership(new Vector3(-703.8819f, -1398.048f, 5.495286f), 137.6665f, "Elitás Travel", "There's first class and then there's Elitas","ElitasMenu") {
                ...
                BannerImagePath = "elitastravel.png",
    ...
    private void DefaultConfig_VehicleExporters()
    {
        VehicleExporters = new List<VehicleExporter>()
        {
            new VehicleExporter(new Vector3(89.00745f,-2564.649f,6.004591f), 1.725455f, "Pacfic Bait Exports", "Take our Bait!","SunshineMenu")
            {
                ...
                OpenTime = 0,
                CloseTime = 24,
                BannerImagePath = "pacificbait.png",
            },
            new VehicleExporter(new Vector3(845.3537f, -951.5338f, 26.52109f), 270.8987f, "National Transport", "When it needs to disappear!","NationalMenu")
            {
                ...
                OpenTime = 0,
                CloseTime = 24,
                BannerImagePath = "nationaltransports.png",
            },
    ...
    private void DefaultConfig_FoodStands()
    {
        FoodStands = new List<FoodStand>()
        {
            ...
            new FoodStand(new Vector3(2106.954f, 4947.911f, 40.95187f), 319.9109f, "Attack-A-Taco", "Heavy Shelling!","TacoFarmerMenu") { BannerImagePath = "attackataco.png",VendorPosition = new Vector3(2106.954f, 4947.911f, 40.95187f), VendorHeading = 319.9109f, },
            new FoodStand(new Vector3(-1148.969f, -1601.963f, 4.390241f), 35.73399f, "Gyro Day", "Gyro Day","GenericMenu") { BannerImagePath = "gyroday.png", VendorPosition = new Vector3(-1145.969f, -1602.963f, 4.390241f), VendorHeading = 35.73399f, },
    ...
    private void DefaultConfig_GasStations()
    {
        GasStations = new List<GasStation>()
        {
           ...
           // new GasStation(new Vector3(-1429.33f,-270.8909f,46.2077f), 325.7301f, "Ron","Put RON in your tank","RonMenu") { BannerImagePath = "ron.png",OpenTime = 4, CloseTime = 22 },
            ...
            new GasStation(new Vector3(1705.88f, 6425.68f, 33.37f), 153.9039f, "Globe Oil", "Changing the Climate, Powering The Future","GasStationMenu") { BannerImagePath = "globeoil.png",ScannerFilePath = "01_specific_location\\0x007AC3FC.wav" },
            ...
            new GasStation(new Vector3(646.0997f, 267.417f, 103.2494f), 58.99448f, "Globe Oil", "Changing the Climate, Powering The Future","GasStationMenu") { BannerImagePath = "globeoil.png" },
            new GasStation(new Vector3(-342.2267f, -1475.199f, 30.74949f), 265.7801f, "Globe Oil", "Changing the Climate, Powering The Future","GasStationMenu"){ BannerImagePath = "globeoil.png" },
    ...
    private void DefaultConfig_ConvenienceStores()
    {
        ConvenienceStores = new List<ConvenienceStore>()
        {
            ...
            new ConvenienceStore(new Vector3(-1264.064f, -1162.599f, 6.764161f), 161.218f,  "Fruit Of The Vine", "Not just for winos","FruitVineMenu"){ BannerImagePath = "fruitofthevine.png" },
            new ConvenienceStore(new Vector3(-1270.649f, -304.9037f, 37.06938f), 257.2106f,  "Fruit Of The Vine", "Not just for winose","FruitVineMenu") { BannerImagePath = "fruitofthevine.png", IsOnMPMap = false},
            new ConvenienceStore(new Vector3(164.9962f, 351.1263f, 109.6859f), 4.847032f,  "Fruit Of The Vine", "Not just for winos","FruitVineMenu") { BannerImagePath = "fruitofthevine.png" },
            new ConvenienceStore(new Vector3(-144.3732f, -65.01408f, 54.60635f), 159.0404f,  "Fruit Of The Vine", "Not just for winos","FruitVineMenu") { BannerImagePath = "fruitofthevine.png" },
            new ConvenienceStore(new Vector3(-1412.015f, -320.1292f, 44.37897f), 92.48502f,  "The Grain Of Truth", "Seek the truth","GrainOfTruthMenu"){ BannerImagePath = "grainoftruth.png" },
            new ConvenienceStore(new Vector3(-1370.819f, -684.5463f, 25.01069f), 214.6929f,  "The Grain Of Truth", "Seek the truth","GrainOfTruthMenu"){ BannerImagePath = "grainoftruth.png" },
    ...
    private void DefaultConfig_Landmarks()
    {
        Landmarks = new List<Landmark>()
        {
            new Landmark(new Vector3(-248.491f, -2010.509f, 34.574f), 0f,"Maze Bank Arena","I heard Fame or Shame was filming there") {OpenTime = 0,CloseTime = 24, InteriorID = 78338,
                ...
                PossiblePedSpawns = new List<ConditionalLocation>() {
                    new SecurityConditionalLocation(new Vector3(-259.8679f, -2034.324f, 29.94604f), 223.56f, 100f) { TaskRequirements = TaskRequirements.Guard | TaskRequirements.StandardScenario, RequiredPedGroup = "UnarmedSecurity" },
                    new SecurityConditionalLocation(new Vector3(-247.7519f, -2021.055f, 29.94604f), 234.7717f, 100f) { TaskRequirements = TaskRequirements.Guard | TaskRequirements.Patrol| TaskRequirements.StandardScenario, RequiredPedGroup = "UnarmedSecurity" },
                    new SecurityConditionalLocation(new Vector3(-246.484f, -2050.29f, 27.75544f), 272.5661f, 100f) { TaskRequirements = TaskRequirements.Guard | TaskRequirements.StandardScenario, RequiredPedGroup = "UnarmedSecurity" },
                },
                PossibleVehicleSpawns = new List<ConditionalLocation>() {
                    new SecurityConditionalLocation(new Vector3(-217.3633f, -2046.552f, 27.62042f), 140.1676f, 100f) { IsEmpty = false, RequiredPedGroup = "UnarmedSecurity" },
            ...
            new Landmark(new Vector3(-3022.02f, 83.00665f, 10.64196f), 0f,"Pacific Bluffs Country Club","Members only") { OpenTime = 0,CloseTime = 24,ScannerFilePath = "01_specific_location\\0x0431FE2B.wav",
                AssignedAssociationID = "GRP6",
                PossiblePedSpawns = new List<ConditionalLocation>() { new SecurityConditionalLocation(new Vector3(-3018.087f, 82.32686f, 11.6775f), 342.6718f, 100f) { TaskRequirements = TaskRequirements.Guard | TaskRequirements.Patrol | TaskRequirements.StandardScenario, RequiredPedGroup = "UnarmedSecurity" }, },
                PossibleVehicleSpawns = new List<ConditionalLocation>() { new SecurityConditionalLocation(new Vector3(-2999.777f, 95.82683f, 11.26355f), 135.1711f, 55f),
            ...
            new Landmark(new Vector3(-2297.172f, 291.5488f, 169.6022f), 114.109f, "Kortz Center", "The center of enlightenment"){ OpenTime = 0,CloseTime = 24,CanInteract = false
    ...
    private void DefaultConfig_HardwareStores()
    {
        HardwareStores = new List<HardwareStore>() {
            ...
            new HardwareStore(new Vector3(339.4021f, -776.9934f, 29.2665f), 68.51967f, "Krapea", "We fake it, you make it","ToolMenu"){ BannerImagePath = "krapea.png" },
    ...
    private void DefaultConfig_HeadShops()
    {
        HeadShops = new List<HeadShop>() {
            ...
            new HeadShop(new Vector3(278.8327f, -1027.653f, 29.21136f), 184.1326f, "Pipe Down Cigars", "","HeadShopMenu"){ BannerImagePath = "pipedown.png" },
            new HeadShop(new Vector3(-1154.942f, -1373.176f, 5.061489f), 305.589f, "Amnesiac Smoke Shop", "","WeedAndCigMenu"),
            new HeadShop(new Vector3(-269.2553f, 243.7069f, 90.40055f), 1.693904f, "Pipe Down", "","HeadShopMenu"){ BannerImagePath = "pipedown.png" },
    ...
    private void DefaultConfig_Pharmacies()
    {
        ...
        {
            new Pharmacy(new Vector3(114.2954f, -4.942202f, 67.82149f), 195.4308f,  "Pop's Pills", "","PharmacyMenu") { BannerImagePath = "popspills.png", },
            ...
            new Pharmacy(new Vector3(151.0329f, 6647.418f, 31.594f), 135.0961f, "Pop's Pills", "","PharmacyMenu"){ BannerImagePath = "popspills.png", },
    ...
    private void DefaultConfig_Restaurants()
    {
        Restaurants = new List<Restaurant>()
        {
            ...
            new Restaurant(new Vector3(-1229.61f, -285.7077f, 37.73843f), 205.5755f, "Noodle Exchange", "You Won't Want To Share!","NoodleMenu", FoodType.Korean) { BannerImagePath = "noodleexchange.png" },
            new Restaurant(new Vector3(-1199.53f, -1162.439f, 7.696731f), 107.0593f, "Noodle Exchange", "You Won't Want To Share!","NoodleMenu", FoodType.Korean){ BannerImagePath = "noodleexchange.png" },
            new Restaurant(new Vector3(272.8409f, -965.4847f, 29.31605f), 27.34526f, "Noodle Exchange", "You Won't Want To Share!","NoodleMenu", FoodType.Korean){ BannerImagePath = "noodleexchange.png" },
            ...
            new Restaurant(new Vector3(-1183.638f, -884.3126f, 13.79987f), 303.1936f, "Burger Shot", "Kill your hunger! It's bleedin' tasty","BurgerShotMenu", FoodType.Burger | FoodType.FastFood) { BannerImagePath = "burgershot.png", ScannerFilePath = "01_specific_location\\0x14C89994.wav" },
            new Restaurant(new Vector3(-1687.276f, -1091.789f, 13.15192f), 132.5498f, "Burger Shot", "Kill your hunger! It's bleedin' tasty","BurgerShotMenu", FoodType.Burger | FoodType.FastFood) { BannerImagePath = "burgershot.png", },
            new Restaurant(new Vector3(1241.453f, -366.7538f, 69.08221f), 164.3345f, "Horny's Burgers", "The beef with the bone!","HornysBurgersMenu", FoodType.Burger | FoodType.FastFood){ BannerImagePath = "hornys.png" },
            ...
            new Restaurant(new Vector3(125.9558f, -1537.896f, 29.1772f), 142.693f, "La Vaca Loca", "Whats wrong with a few mad cows?","LaVacaLocaMenu", FoodType.Burger) { BannerImagePath = "vacaloca.png", CameraPosition = new Vector3(137.813f, -1561.211f, 37.43506f), CameraDirection = new Vector3(-0.1290266f, 0.9696004f, -0.2079113f), CameraRotation = new Rotator(-11.99998f, -2.182118E-07f, 7.579925f) },
            ...
            new Restaurant(new Vector3(-1206.975f, -1135.029f, 7.693257f), 109.1408f, "Cool Beans Coffee Co", "Come flick our beans","CoffeeMenu", FoodType.Coffee){ BannerImagePath = "coolbeans.png" },
            new Restaurant(new Vector3(-1278.833f, -876.438f, 11.9303f), 123.2498f, "Cool Beans Coffee Co", "Come flick our beans","CoffeeMenu", FoodType.Coffee){ BannerImagePath = "coolbeans.png" },
            new Restaurant(new Vector3(1169.704f, -403.1992f, 72.24859f), 344.0863f, "Cool Beans Coffee Co", "Come flick our beans","CoffeeMenu", FoodType.Coffee){ BannerImagePath = "coolbeans.png" },
            new Restaurant(new Vector3(265.4628f, -981.3839f, 29.36569f), 72.07395f, "Cool Beans Coffee Co", "Come flick our beans","CoffeeMenu", FoodType.Coffee){ BannerImagePath = "coolbeans.png" },
            ...
            //Mexican
            new Restaurant(new Vector3(10.96682f, -1605.874f, 29.3931f), 229.8729f, "The Taco Farmer", "Open All Hours!","TacoFarmerMenu", FoodType.Mexican) { OpenTime = 0, CloseTime = 24, BannerImagePath = "tacofarmer.png" },
            new Restaurant(new Vector3(649.765f, 2728.621f, 41.9959f), 276.2882f, "The Taco Farmer", "Open All Hours!","TacoFarmerMenu", FoodType.Mexican) { OpenTime = 0, CloseTime = 24, BannerImagePath = "tacofarmer.png" },
            ...
            new Restaurant(new Vector3(445.9454f, -1241.581f, 30.27799f), 179.553f, "Attack-A-Taco", "Kill that hunger","TacoFarmerMenu", FoodType.Mexican) { BannerImagePath = "attackataco.png" },
            ...
            //Chicken
            new Restaurant(new Vector3(-584.761f, -872.753f, 25.91489f), 353.0746f, "Lucky Plucker", "Come be a real Lucky Plucker","LuckyPluckerMenu", FoodType.Chicken | FoodType.FastFood) {ScannerFilePath = "01_specific_location\\0x14B8A4DB.wav", BannerImagePath = "luckyplucker.png" },
            new Restaurant(new Vector3(2580.543f, 464.6521f, 108.6232f), 176.5548f, "Bishop's Chicken", "Our chicken is a religious experience","BishopsChickenMenu", FoodType.Chicken | FoodType.FastFood){ BannerImagePath = "bishops.png" },
            new Restaurant(new Vector3(169.3292f, -1634.163f, 29.29167f), 35.89598f, "Bishop's Chicken", "Our chicken is a religious experience","BishopsChickenMenu", FoodType.Chicken | FoodType.FastFood){ BannerImagePath = "bishops.png" },
            new Restaurant(new Vector3(133.0175f, -1462.702f, 29.35705f), 48.47223f, "Lucky Plucker", "Come be a real Lucky Plucker","LuckyPluckerMenu", FoodType.Chicken | FoodType.FastFood){ BannerImagePath = "luckyplucker.png" },
            new Restaurant(new Vector3(-138.4921f, -256.509f, 43.59497f), 290.1001f, "Cluckin' Bell", "Taste the cock","CluckinBellMenu", FoodType.Chicken | FoodType.FastFood){ BannerImagePath = "cluckin.png", },
            new Restaurant(new Vector3(-184.9376f, -1428.169f, 31.47968f), 33.8636f, "Cluckin' Bell", "Taste the cock","CluckinBellMenu", FoodType.Chicken | FoodType.FastFood){ BannerImagePath = "cluckin.png", },
            new Restaurant(new Vector3(-1681.603f, -1096.505f, 13.15227f), 180.3125f, "Cluckin' Bell", "Taste the cock","CluckinBellMenu", FoodType.Chicken | FoodType.FastFood) { BannerImagePath = "cluckin.png", },
            //General    
            ...
            new Restaurant(new Vector3(-1535.082f, -422.2449f, 35.59194f), 229.4618f, "Chihuahua Hot Dogs", "Vegan? No. Meat? Yes.","ChihuahuaHotDogMenu", FoodType.FastFood) { BannerImagePath = "chihuahuahotdogs.png" },
            new Restaurant(new Vector3(49.24896f, -1000.381f, 29.35741f), 335.6092f, "Chihuahua Hot Dogs", "Vegan? No. Meat? Yes.","ChihuahuaHotDogMenu", FoodType.FastFood){ BannerImagePath = "chihuahuahotdogs.png" },
    ...
    private void DefaultConfig_Hospitals()
    {
        Hospitals = new List<Hospital>()
        {
            new Hospital(new Vector3(359.6708f, -584.4868f, 28.81813f), 255.1885f, "Pill Box Hill Medical Center","Some of the most famous people of LS have died here") { OpenTime = 0,CloseTime = 24, InteriorID = -787, PossiblePedSpawns = new List<ConditionalLocation>() {
                ...
                new EMSConditionalLocation(new Vector3(355.4031f, -598.8352f, 28.77448f), 250.9611f, 50f),
                new EMSConditionalLocation(new Vector3(364.3289f, -579.7377f, 28.84095f), 227.9576f, 50f),
                new EMSConditionalLocation(new Vector3(299.7511f, -579.8925f, 43.26084f), 72.9278f, 50f),
            }
            ...
            new Hospital(new Vector3(343.5177f, -1399.408f, 32.50927f), 49.67379f, "Central LS Medical Center","Gang Related Injury? We take Fleeca and Limit cards") {OpenTime = 0,CloseTime = 24, ScannerFilePath= "01_specific_location\\0x13583D6F.wav", PossiblePedSpawns = new List<ConditionalLocation>() {
                ...
                new EMSConditionalLocation(new Vector3(333.7716f, -1381.868f, 32.50922f), 80.20363f, 50f),
                new EMSConditionalLocation(new Vector3(327.9682f, -1393.585f, 32.50924f), 23.40009f, 50f),
                new EMSConditionalLocation(new Vector3(297.9529f, -1448.031f, 29.96662f), 306.945f, 50f),
                new EMSConditionalLocation(new Vector3(361.8272f, -1465.073f, 29.28194f), 178.0938f, 50f),
            }
            ...
            new Hospital(new Vector3(1839.211f, 3673.892f, 34.27668f), 215.6462f, "Sandy Shores Medical Center","Just as good as those REAL hospitals in LS") {OpenTime = 0,CloseTime = 24, PossiblePedSpawns = new List<ConditionalLocation>() {
                ...
                new EMSConditionalLocation(new Vector3(1835.39f, 3670.011f, 34.27673f), 172.621f, 50f),
                new EMSConditionalLocation(new Vector3(1844.322f, 3672.015f, 33.67998f), 196.141f, 50f),
            }
            ...
            new Hospital(new Vector3(-248.4412f, 6332.721f, 32.42618f), 225.41f, "The Bay Care Center","One stop shopping! Funeral Home and Crematorium on site") {OpenTime = 0,CloseTime = 24, PossiblePedSpawns = new List<ConditionalLocation>() {
                ...
                new EMSConditionalLocation(new Vector3(-242.6317f, 6324.892f, 32.42618f), 318.8682f, 50f),
                new EMSConditionalLocation(new Vector3(-238.915f, 6314.112f, 31.48628f), 227.0187f, 50f),
            }
            ...
            new Hospital(new Vector3(1151.386f, -1529.34f, 35.36609f), 337.4726f, "St. Fiacre Hospital", "Come see the most expensive specialists in LS") {OpenTime = 0,CloseTime = 24, PossiblePedSpawns = new List<ConditionalLocation>() {
                ...
                new EMSConditionalLocation(new Vector3(1150.269f, -1524.425f, 34.84344f), 316.4077f, 50f),
                new EMSConditionalLocation(new Vector3(1137.925f, -1514.329f, 34.84341f), 327.5841f, 50f),
                new EMSConditionalLocation(new Vector3(1171.36f, -1520.041f, 34.8434f), 319.8948f, 50f),
            }
            ...
            new Hospital(new Vector3(-449.76f, -341.03f, 35.5f), 106f, "Mount Zonah Medical Center", "The hospital with the largest advertising budget") { OpenTime = 0,CloseTime = 24,
                PossiblePedSpawns = new List<ConditionalLocation>() {
                    new EMSConditionalLocation(new Vector3(-448.7528f, -334.6505f, 33.5019f), 161.25828389f, 50f),
                    new EMSConditionalLocation(new Vector3(-447.4306f, -328.7594f, 33.50186f), 190.084495712696f,50f),
                    new EMSConditionalLocation(new Vector3(-447.0008f, -329.9945f, 33.50186f), 27.4845562493075f,50f),
                    new EMSConditionalLocation(new Vector3(-496.9766f, -331.2807f, 33.50167f), 223.606079066179f,50f),
                    new EMSConditionalLocation(new Vector3(-464.4201f, -353.7608f, 33.39479f), 111.44917199877f,50f),
            }
    ...
    private void DefaultConfig_Prisons()
    {
        Prisons = new List<Prison>()
        {
            new Prison(new Vector3(1846.258f, 2586.139f, 45.67202f), 269.2306f, "Bolingbroke Penitentiary","Where the scum of LS washes up")  { OpenTime = 0,CloseTime = 24,AssignedAssociationID = "SASPA",
                ...
                new LEConditionalLocation(new Vector3(1869.82f, 2588.359f, 46.42464f), 269f, 75f),//facing away from prison
                 new LEConditionalLocation(new Vector3(1854.312f, 2620.756f, 46.42464f), 92f, 75f),//facing towards prison
                 new LEConditionalLocation( new Vector3(1869.65f, 2577.781f, 45.18463f), 269f, 75f),//facing away from prison
        ...
        PoliceStations = new List<PoliceStation>()
        {
            ...
            new PoliceStation(new Vector3(1855.447f, 3682.999f, 34.26752f), 209.9094f,  "Sandy Shores Sheriff's Station","A Tradition of Suppression") {
              ...
              //  CameraDirection = new Vector3(-0.8681535f, 0.4227323f, -0.2600135f),
               // CameraRotation = new Rotator(-15.07086f, 3.53674E-06f, 64.03703f),
                ...
                PossibleVehicleSpawns = new List<ConditionalLocation>() {
                    new LEConditionalLocation(new Vector3(1831.629f, 3662.91f, 33.92607f), 32f,50f),
                    new LEConditionalLocation(new Vector3(1835.127f, 3664.892f, 33.92607f), 32f,50f),
            ...
            new PoliceStation(new Vector3(434.3387f, -981.8954f, 30.70984f), 89.51098f, "Mission Row Police Station","Obey and Survive") {
               ...
               // CameraRotation = new Rotator(-11.26764f, 1.262302E-05f, -38.25679f),
                ...
                PossibleVehicleSpawns = new List<ConditionalLocation>() {
                    new LEConditionalLocation(new Vector3(407.7554f, -984.2084f, 29.89806f), 228f,20f),
                    new LEConditionalLocation(new Vector3(408.0923f, -988.8488f, 29.85523f), 228f,20f),
                    new LEConditionalLocation(new Vector3(407.9883f, -998.3094f, 29.81112f), 228f,20f),
                    new LEConditionalLocation(new Vector3(427.5909f, -1027.707f, 29.22805f), 185f,20f),
                    new LEConditionalLocation(new Vector3(434.9848f, -1027.103f, 29.12844f), 185f,20f),
                    new LEConditionalLocation(new Vector3(442.5143f, -1026.687f, 28.98147f), 185f,20f),
            ...
            new PoliceStation(new Vector3(827.5469f, -1289.998f, 28.24066f), 86.95251f, "La Mesa Police Station","Obey and Survive") { 
                BannerImagePath = "lspdlamesa.png",
                OpenTime = 0,
                CloseTime = 24, 
            ...
            new PoliceStation(new Vector3(638.4491f, 1.559977f, 82.78642f), 247.7514f,"Vinewood Police Station","Obey and Survive") {
               ...
               // CameraRotation = new Rotator(-13.98198f, 4.399209E-06f, 59.34634f),
                ...
                PossibleVehicleSpawns = new List<ConditionalLocation>() {
                    new LEConditionalLocation(new Vector3(666.4646f, -11.79645f, 82.76681f), 144f,20f),
                    new LEConditionalLocation(new Vector3(621.6934f, 26.27448f, 88.66011f), 193f,20f),
                    new LEConditionalLocation(new Vector3(615.3292f, 28.48364f, 89.28476f), 193f,20f),
                    new LEConditionalLocation(new Vector3(609.7616f, 30.84756f, 89.91243f), 193f,20f),
                    new LEConditionalLocation(new Vector3(597.8726f, 34.8121f, 91.07567f), 193f,20f),
                    new LEConditionalLocation(new Vector3(586.7384f, 37.78894f, 92.30818f), 193f,20f),
            ...
            new PoliceStation(new Vector3(-557.0687f, -134.7315f, 38.20231f), 214.5968f, "Rockford Hills Police Station","Obey and Survive") {
                ...
                PossibleVehicleSpawns = new List<ConditionalLocation>() {
                    new LEConditionalLocation(new Vector3(-574.256f, -168.7862f, 38.49216f), 291f,20f),
                    new LEConditionalLocation(new Vector3(-557.7739f, -161.9565f, 38.62593f), 291f,20f),
                    new LEConditionalLocation(new Vector3(-559.7783f, -147.1107f, 38.65532f), 58f,20f),
                    new LEConditionalLocation(new Vector3(-555.6528f, -145.4567f, 38.72502f), 58f,20f),
            ...
            new PoliceStation(new Vector3(-1093.817f, -807.1993f, 19.28864f), 22.23846f, "Vespucci Police Station","Obey and Survive") {
                ...
                PossibleVehicleSpawns = new List<ConditionalLocation>() {
                    new LEConditionalLocation(new Vector3(-1072.822f, -880.3561f, 4.809089f), 208f,20f),
                    new LEConditionalLocation(new Vector3(-1075.95f, -882.3492f, 4.809089f), 208f,20f),
                    new LEConditionalLocation(new Vector3(-1051.726f, -867.1277f, 4.809089f), 230f,20f),
                    new LEConditionalLocation(new Vector3(-1045.53f, -861.5321f, 4.809089f), 230f,20f),
                    new LEConditionalLocation(new Vector3(-1042.226f, -857.9979f, 4.809089f), 230f,20f),
                    new LEConditionalLocation(new Vector3(-1047.814f, -846.7044f, 4.809089f), 37f,20f),
                    new LEConditionalLocation(new Vector3(-1052.352f, -846.8544f, 4.809089f), 37f,20f),
                    new LEConditionalLocation(new Vector3(-1055.076f, -849.5068f, 4.809089f), 37f,20f),
                    new LEConditionalLocation(new Vector3(-1058.752f, -851.4465f, 4.809089f), 37f,20f),
                    new LEConditionalLocation(new Vector3(-1126.5f, -864.8307f, 13.63185f), 220f,20f),
                    new LEConditionalLocation(new Vector3(-1122.896f, -863.4746f, 13.6122f), 220f,20f),
                    new LEConditionalLocation(new Vector3(-1115.937f, -857.7859f, 13.65187f), 220f,20f),
            ...
            new PoliceStation(new Vector3(102.9145f, -743.9487f, 45.75473f), 79.8266f, "FIB Headquarters","We're corrupt in a good way") { 
                ...
                PossiblePedSpawns = new List<ConditionalLocation>() {
                    new LEConditionalLocation(new Vector3(101.3534f, -745.8216f, 45.75475f), 76.27069f, 50f),
                    new LEConditionalLocation(new Vector3(117.8028f, -747.0616f, 45.75158f), 102.5501f, 50f),
                    new LEConditionalLocation(new Vector3(113.9787f, -758.2271f, 45.75474f), 21.6145f, 50f),
                } },
            new PoliceStation(new Vector3(387.16f, 789.96f, 188.23f), 178f, "Beaver Bush Ranger Station","You won't get this bush!") { 
                ...
                CloseTime = 24, 
                PossiblePedSpawns = new List<ConditionalLocation>() {
                    new LEConditionalLocation(new Vector3(391.3105f, 789.5917f, 186.6761f), 178f,75f),
                    new LEConditionalLocation(new Vector3(381.8302f, 789.8931f, 186.6757f), 178f,75f),
                },
                PossibleVehicleSpawns = new List<ConditionalLocation>(){ 
            ...
            new PoliceStation(new Vector3(-893.9146f, -2401.547f, 14.02436f), 148.8757f, "NOoSE LSIA","Let's tighten the noose!") { 
                ...
                PossibleVehicleSpawns = new List<ConditionalLocation>()
                {
                    ...
                    new LEConditionalLocation(new Vector3(-900.9653f, -2391.173f, 13.47696f), 148.7623f, 75f) { AssociationID = "NOOSE-PIA" },
                    new LEConditionalLocation(new Vector3(-862.1013f, -2414.928f, 13.47701f), 147.4044f, 75f),
                    new LEConditionalLocation(new Vector3(-858.2088f, -2397.289f, 13.47724f), 161.3987f, 75f) { AssociationID = "NOOSE-BP" },
                    new LEConditionalLocation(new Vector3(-890.4263f, -2377.496f, 13.47698f), 70.6132f, 75f),
                    new LEConditionalLocation(new Vector3(-873.713f, -2419.414f, 13.94444f), 53.94463f, 75f) { AssociationID = "NOOSE-PIA" },
                } },
    ...
    private void DefaultConfig_Residences()
    {
        Residences = new List<Residence>()
        {
            //NEW
            //Vespucci
            new Residence(new Vector3(-1035.18f, -1146.53f, 2.16f), 32.45f, "68 Vespucci Canals", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 450000, SalesPrice = 350000, RentalDays = 28, RentalFee = 2400  },
            new Residence(new Vector3(-960.14f, -1109.21f, 2.15f), 33.94f, "87 Vespucci Canals", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 380000, SalesPrice = 300000,RentalDays = 28, RentalFee = 2000  },
            new Residence(new Vector3(-951.51f, -1078.93f, 2.15f), 207.97f, "88 Vespucci Canals", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 490000,SalesPrice = 350000, RentalDays = 28, RentalFee = 2500  },
            new Residence(new Vector3(-1183.19f, -1064.55f, 2.15f), 114.64f, "42 Vespucci Canals", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 400000,SalesPrice = 300000, RentalDays = 28, RentalFee = 2000  },
            new Residence(new Vector3(-983.25f, -1065.88f, 2.15f), 30.08f, "86 Vespucci Canals", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 440000,SalesPrice = 300000, RentalDays = 28, RentalFee = 2300  },
            new Residence(new Vector3(-1064.27f, -1159.15f, 2.16f), 31.65f, "65 Vespucci Canals", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 400000,SalesPrice = 300000, RentalDays = 28, RentalFee = 2000  },
            
            //Mirror Park
            new Residence(new Vector3(987.9448f, -525.9558f, 60.69062f), 208.7025f, "114 Nikola Ave", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 390000,SalesPrice = 310000, RentalDays = 28, RentalFee = 2000  },
            new Residence(new Vector3(976.0329f, -579.8205f, 59.63558f), 30.60654f, "115 Nikola Ave", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 360000,SalesPrice = 300000, RentalDays = 28, RentalFee = 2000  },
            new Residence(new Vector3(1323.468f, -583.0522f, 73.24638f), 334.7151f, "104 East Mirror Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 480000,SalesPrice = 360000, RentalDays = 28, RentalFee = 2500  },
            new Residence(new Vector3(1372.544f, -555.1687f, 74.68565f), 153.1011f, "107 East Mirror Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 500000,SalesPrice = 380000, RentalDays = 28, RentalFee = 2600  },
            new Residence(new Vector3(999.5336f, -593.9052f, 59.63857f), 259.7758f, "93 Mirror Pl", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 270000,SalesPrice = 210000, RentalDays = 28, RentalFee = 1500  },
            new Residence(new Vector3(979.8713f, -627.104f, 59.23589f), 124.2795f, "218 West Mirror Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 400000,SalesPrice = 350000, RentalDays = 28, RentalFee = 3000  },

            new Residence(new Vector3(1060.462f, -378.1198f, 68.23125f), 229.2095f, "112 Bridge St", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 350000,SalesPrice = 310000, RentalDays = 28, RentalFee = 2000  },
            new Residence(new Vector3(1051.598f, -470.5955f, 63.91349f), 257.9751f, "118 Bridge St", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 335000,SalesPrice = 300000, RentalDays = 28, RentalFee = 1700  },
            ...
            new Residence(new Vector3(980.1745f, 2666.563f, 40.04342f), 1.699184f, "140 Route 68", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 225000,SalesPrice = 180000, RentalDays = 28, RentalFee = 1250  },
            new Residence(new Vector3(-3030.045f, 568.7484f, 7.823583f), 280.3508f, "566 Ineseno Rd", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 556000,SalesPrice = 320000, RentalDays = 28, RentalFee = 2200 },
            new Residence(new Vector3(-3031.865f, 525.1087f, 7.424246f), 267.6694f, "800 Ineseno Rd", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 467000,SalesPrice = 310000, RentalDays = 28, RentalFee = 1850  },
            new Residence(new Vector3(-3039.567f, 492.8512f, 6.772703f), 226.448f, "805 Ineseno Rd", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 450000,SalesPrice = 350000, RentalDays = 28, RentalFee = 1750  },
            new Residence(new Vector3(195.0935f, 3031.064f, 43.89068f), 273.1078f, "125 Joshua Rd", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 298000,SalesPrice = 210000, RentalDays = 28, RentalFee = 1580  },
            new Residence(new Vector3(191.0053f, 3082.26f, 43.47285f), 277.6117f, "610N Joshua Rd", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 289000,SalesPrice = 200000, RentalDays = 28, RentalFee = 1675  },
            new Residence(new Vector3(241.7666f, 3107.666f, 42.48719f), 93.76467f, "620N Joshua Rd", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 275000,SalesPrice = 190000, RentalDays = 28, RentalFee = 1610  },
            new Residence(new Vector3(162.8214f, 3119.749f, 43.42594f), 192.0786f, "621N Joshua Rd", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 57000,SalesPrice = 35000, RentalDays = 28, RentalFee = 850  },
            ...
            new Residence(new Vector3(-272.7155f, 6400.906f, 31.50496f), 215.1084f, "1275N Procopio Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 470000,SalesPrice = 350000, RentalDays = 28, RentalFee = 1850  },
            new Residence(new Vector3(-247.7424f, 6370.079f, 31.84554f), 45.0573f, "1276N Procopio Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 476000,SalesPrice = 350000, RentalDays = 28, RentalFee = 1790  },
            new Residence(new Vector3(-227.3544f, 6377.188f, 31.75924f), 47.93699f, "1278N Procopio Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 414000,SalesPrice = 320000, RentalDays = 28, RentalFee = 1670  },
            new Residence(new Vector3(-245.4691f, 6413.878f, 31.4606f), 130.3203f, "1281N Procopio Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 455000,SalesPrice = 330000, RentalDays = 28, RentalFee = 1770  },
            new Residence(new Vector3(-213.7807f, 6395.94f, 33.08509f), 40.99633f, "1282N Procopio Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 435000,SalesPrice = 350000, RentalDays = 28, RentalFee = 1680  },
            new Residence(new Vector3(-189.0498f, 6409.355f, 32.29676f), 48.98f, "1285N Procopio Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 445000,SalesPrice = 350000, RentalDays = 28, RentalFee = 1650  },
            new Residence(new Vector3(-280.4388f, 6350.718f, 32.60079f), 24.08426f, "1271N Procopio Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 247000,SalesPrice = 210000, RentalDays = 28, RentalFee = 1380  },
            new Residence(new Vector3(-359.5872f, 6334.424f, 29.84736f), 226.0376f, "1260N Procopio Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 565000,SalesPrice = 450000, RentalDays = 28, RentalFee = 2200  },
            new Residence(new Vector3(-332.7523f, 6301.959f, 33.08874f), 69.82259f, "1262N Procopio Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 257000,SalesPrice = 240000, RentalDays = 28, RentalFee = 1480  },
            new Residence(new Vector3(-407.2561f, 6314.223f, 28.94128f), 230.5133f, "1259N Procopio Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 414000,SalesPrice = 390000, RentalDays = 28, RentalFee = 1870  },
            new Residence(new Vector3(-437.4564f, 6261.807f, 30.06895f), 228.8042f, "1252N Procopio Dr", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 520000,SalesPrice = 410000, RentalDays = 28, RentalFee = 2100  },
            new Residence(new Vector3(1880.423f, 3921.08f, 33.21722f), 100.0703f, "785N Niland Ave", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 224000,SalesPrice = 210000, RentalDays = 28, RentalFee = 1280  },
            new Residence(new Vector3(-37.54279f, 170.3245f, 95.35922f), 303.8834f, "Elgin House Apartment 23E", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 404000,SalesPrice = 350000, RentalDays = 28, RentalFee = 1650  },
            new Residence(new Vector3(9.063264f, 52.93087f, 71.64354f), 344.3057f, "0605 Apartment 4F", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 375000,SalesPrice = 280000, RentalDays = 28, RentalFee = 1570  },
            new Residence(new Vector3(76.05615f, -86.96131f, 63.00647f), 249.8842f, "1144 Apartment 2B", "") {OpenTime = 0,CloseTime = 24, PurchasePrice = 380000,SalesPrice = 290000, RentalDays = 28, RentalFee = 1660  },
            new Residence(new Vector3(1683.038f, 4689.635f, 43.06602f), 269.7168f, "330E Grapeseed", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 200000,SalesPrice = 150000, RentalFee = 1200, RentalDays = 28,},
            new Residence(new Vector3(1674.201f, 4658.228f, 43.37114f), 270.4372f, "335E Grapeseed", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 200000,SalesPrice = 150000, RentalFee = 1200, RentalDays = 28,},
            new Residence(new Vector3(1725.289f, 4642.35f, 43.87548f), 115.7792f, "340E Grapeseed", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 250000,SalesPrice = 150000, RentalFee = 1350, RentalDays = 28,},
            new Residence(new Vector3(1881.219f, 3810.713f, 32.77882f), 301.1151f, "370E Niland ", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 150000,SalesPrice = 90000, RentalFee = 950, RentalDays = 28,},
            new Residence(new Vector3(1899.071f, 3781.417f, 32.8769f), 299.5774f, "380E Niland", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 175000,SalesPrice = 1500000, RentalFee = 1000, RentalDays = 28,},
            new Residence(new Vector3(-3186.93f, 1274.122f, 12.66124f), 257.7415f, "630W Barbareno", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 750000,SalesPrice = 650000, RentalFee = 3000, RentalDays = 28,},
            new Residence(new Vector3(-3194.785f, 1179.539f, 9.659509f), 258.9255f, "632W Barbareno", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 650000,SalesPrice = 550000, RentalFee = 2700, RentalDays = 28,},
            new Residence(new Vector3(-3238.444f, 952.556f, 13.34334f), 281.2452f, "642W Barbareno", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 670000,SalesPrice = 550000, RentalFee = 2800, RentalDays = 28,},
            new Residence(new Vector3(-3093.812f, 349.4576f, 7.544847f), 258.988f, "611W Ineseno", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 1200000,SalesPrice = 980000, RentalFee = 4000, RentalDays = 28,},
            new Residence(new Vector3(312.721f, -1956.719f, 24.42436f), 229.223f, "61E Jamestown ", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 330000,SalesPrice = 280000, RentalFee = 1400, RentalDays = 28,},
            new Residence(new Vector3(256.5888f, -2023.559f, 19.26631f), 227.9232f, "50E Jamestown", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 400000,SalesPrice = 320000, RentalFee = 1800, RentalDays = 28,},
            new Residence(new Vector3(165.2183f, -1944.738f, 20.23543f), 228.8544f, "30E Roy Lowenstein", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 425000,SalesPrice = 330000, RentalFee = 1870, RentalDays = 28,},
            new Residence(new Vector3(150.2098f, -1864.915f, 24.59134f), 153.5939f, "20E Covenant", ""){OpenTime = 0,CloseTime = 24, PurchasePrice = 250000,SalesPrice = 190000, RentalFee = 1300, RentalDays = 28,},
            new Residence(new Vector3(114.7368f, -1887.42f, 23.92823f), 333.4948f, "21E Covenant", ""){ OpenTime = 0,CloseTime = 24,PurchasePrice = 275000,SalesPrice = 180000, RentalFee = 1000, RentalDays = 28,},
            new Residence(new Vector3(54.01227f, -1873.436f, 22.80583f), 128.9813f, "10E Grove Street", ""){OpenTime = 0,CloseTime = 24, PurchasePrice = 225000,SalesPrice = 170000, RentalFee = 1200, RentalDays = 28,},
            new Residence(new Vector3(-5.184085f, -1871.247f, 24.15101f), 317.3572f, "3E Grove St", ""){OpenTime = 0,CloseTime = 24, PurchasePrice = 325000,SalesPrice = 270000, RentalFee = 1500, RentalDays = 28,},
            ...
            new Residence(new Vector3(-1597.134f, -352.3153f, 45.97645f), 230.207f, "Pacific Buff Manor",""){ OpenTime = 0,CloseTime = 24,RentalFee = 5000, RentalDays = 28,PurchasePrice = 1200000,SalesPrice = 980000,},

            //from box in discord
            new Residence(new Vector3(-766.33f, -917.05f, 21.28f), 270f, "1068 Ginger St. Apt 4",""){ OpenTime = 0,CloseTime = 24,RentalFee = 1450, RentalDays = 28,PurchasePrice = 350000,SalesPrice = 300000,},
            ...
            new Residence(new Vector3(-188.97f, 1008.84f, 232.13f), 87f, "202 Lake Vinewood Estate",""){ OpenTime = 0,CloseTime = 24,RentalFee = 12000, RentalDays = 28,PurchasePrice = 1550000,SalesPrice = 1200000,},
            new Residence(new Vector3(-232.71f, 588.12f, 190.54f), 355f, "3636 Kimble Hill Dr",""){ OpenTime = 0,CloseTime = 24,RentalFee = 9100, RentalDays = 28,PurchasePrice = 1250000,SalesPrice = 900000,},
            ...
            new Residence(new Vector3(-773.63f, 313.08f, 85.70f), 180f, "Eclipse Towers Apt 401",""){ OpenTime = 0,CloseTime = 24,RentalFee = 30000, RentalDays = 28,PurchasePrice = 2000000,SalesPrice = 1500000,},
    ...
    private void DefaultConfig_GangDens_Cartel()
    {
        GangDen Den1 = new GangDen(new Vector3(1389.966f, 1131.907f, 114.3344f), 91.72424f, "Madrazo Cartel Den", "", "MadrazoDenMenu", "AMBIENT_GANG_MADRAZO")
        {
            ...
            PossiblePedSpawns = new List<ConditionalLocation>() 
            {
                new GangConditionalLocation(new Vector3(1390.856f, 1139.184f, 114.4433f), 56.59644f, 70f) { TaskRequirements = TaskRequirements.Guard | TaskRequirements.EquipSidearmWhenIdle | TaskRequirements.EquipLongGunWhenIdle, LongGunAlwaysEquipped = true, ForceSidearm = true,ForceLongGun = true },
                new GangConditionalLocation(new Vector3(1383.559f, 1156.695f, 114.3345f), 170.1522f, 70f) { TaskRequirements = TaskRequirements.Guard | TaskRequirements.EquipSidearmWhenIdle | TaskRequirements.EquipLongGunWhenIdle, LongGunAlwaysEquipped = true, ForceSidearm = true,ForceLongGun = true },
                new GangConditionalLocation(new Vector3(1375.004f, 1149.209f, 113.9089f), 91.94662f, 70f) { TaskRequirements = TaskRequirements.Guard | TaskRequirements.CanMoveWhenGuarding | TaskRequirements.EquipSidearmWhenIdle | TaskRequirements.EquipLongGunWhenIdle, LongGunAlwaysEquipped = true, ForceSidearm = true,ForceLongGun = true },
                new GangConditionalLocation(new Vector3(1412.588f, 1138.611f, 114.3341f), 196.4261f, 70f) { TaskRequirements = TaskRequirements.Guard | TaskRequirements.CanMoveWhenGuarding | TaskRequirements.EquipSidearmWhenIdle | TaskRequirements.EquipLongGunWhenIdle, LongGunAlwaysEquipped = true, ForceSidearm = true,ForceLongGun = true },
            },
            PossibleVehicleSpawns = new List<ConditionalLocation>()
            {
    ...
    private void DefaultConfig_GangDens_Yardies()
    {
        GangDen Den1 = new GangDen(new Vector3(-1157.501f, -1451.861f, 4.468448f), 216.5082f, "Yardies Chill Spot", "", "YardiesDenMenu", "AMBIENT_GANG_YARDIES")
        {
            ...
            PossiblePedSpawns = new List<ConditionalLocation>() 
            {
                new GangConditionalLocation(new Vector3(-1155.236f, -1450.92f, 4.508356f), 203.7991f, 70f),
                new GangConditionalLocation(new Vector3(-1158.698f, -1454.306f, 4.346763f), 192.8651f, 70f),
                new GangConditionalLocation(new Vector3(-1166.395f, -1453.536f, 4.367522f), 122.2634f, 70f),
                new GangConditionalLocation(new Vector3(-1177.108f, -1437.649f, 4.379432f), 75.27589f, 70f),
                new GangConditionalLocation(new Vector3(-1171.944f, -1470.263f, 4.382764f), 290.1982f, 70f),
            },
            PossibleVehicleSpawns = new List<ConditionalLocation>()
            {
                new GangConditionalLocation(new Vector3(-1156.718f, -1462.597f, 3.70943f), 210.7057f, 75f),
                new GangConditionalLocation(new Vector3(-1150.134f, -1456.732f, 3.955124f), 215.4072f, 75f),
            }
    ...
    private void DefaultConfig_GangDens_Varrios()
    {
        GangDen Den1 = new GangDen(new Vector3(1193.61f, -1656.411f, 43.02641f), 31.55427f, "Varrios Los Aztecas Den", "", "VarriosDenMenu", "AMBIENT_GANG_SALVA")
        {
            ...
            PossiblePedSpawns = new List<ConditionalLocation>() 
            {
                ...
                new GangConditionalLocation(new Vector3(1189.079f, -1655.169f, 42.358f), 338.5124f, 50f),
                new GangConditionalLocation(new Vector3(1190.508f, -1648.968f, 41.43568f), 34.16187f, 50f),
                new GangConditionalLocation(new Vector3(1172.624f, -1645.602f, 36.78029f), 94.79508f, 50f),
            },
            PossibleVehicleSpawns = new List<ConditionalLocation>()
            {
    ...
    private void DefaultConfig_GangDens_Lost()
    {
        GangDen LostMainDen = new GangDen(new Vector3(981.8542f, -103.0203f, 74.84874f), 220.3094f, "Lost M.C. Clubhouse", "", "LostDenMenu", "AMBIENT_GANG_LOST")
        {
            ...
            PossiblePedSpawns = new List<ConditionalLocation>() 
            {
                new GangConditionalLocation(new Vector3(987.3098f, -107.0706f, 74.32984f), 138.8955f, 55f),
                new GangConditionalLocation(new Vector3(975.0338f, -112.2333f, 74.35313f), 188.1823f, 55f),
                new GangConditionalLocation(new Vector3(960.2211f, -123.5155f, 74.35313f), 181.6973f, 55f),
                new GangConditionalLocation(new Vector3(981.1419f, -142.9071f, 74.23688f), 80.7939f, 55f),
                new GangConditionalLocation(new Vector3(976.2161f, -144.2681f, 74.24052f), 0.7361088f, 55f),
            },
            PossibleVehicleSpawns = new List<ConditionalLocation>()
            {
                new GangConditionalLocation(new Vector3(976.4726f, -132.778f, 73.21405f), 58.86649f, 55f),
                new GangConditionalLocation(new Vector3(960.3214f, -132.2091f, 73.69121f), 189.5355f, 55f),
                new GangConditionalLocation(new Vector3(972.7709f, -142.4676f, 73.60614f), 239.6191f, 55f),
                new GangConditionalLocation(new Vector3(972.8246f, -155.1686f, 72.8443f), 52.89192f, 55f),
            },
        ...
        GangDen LostDen2 = new GangDen(new Vector3(84.04226f, 3718.52f, 39.78923f), 50.35764f, "Lost M.C. The Range", "", "LostDenMenu", "AMBIENT_GANG_LOST")
        {
           ...
           // HasVanillaGangSpawnedAroundToBeBlocked = true,
            PossiblePedSpawns = new List<ConditionalLocation>()
            {
                new GangConditionalLocation(new Vector3(84.73796f, 3718.092f, 40.33084f), 60.53624f, 45f),
                new GangConditionalLocation(new Vector3(80.1135f, 3721.855f, 39.74522f), 150.8561f, 45f),
                new GangConditionalLocation(new Vector3(78.30386f, 3722.036f, 39.74952f), 266.9375f, 45f),
                new GangConditionalLocation(new Vector3(67.40894f, 3703.18f, 39.75497f), 338.0555f, 45f),
                new GangConditionalLocation(new Vector3(68.87956f, 3704.888f, 39.75497f), 120.9388f, 45f),
                new GangConditionalLocation(new Vector3(47.73441f, 3704.631f, 39.75497f), 302.5045f, 45f),
                new GangConditionalLocation(new Vector3(47.20625f, 3705.412f, 39.75497f), 269.3896f, 45f),
                new GangConditionalLocation(new Vector3(46.69005f, 3715.68f, 39.73444f), 245.4069f, 45f),
                new GangConditionalLocation(new Vector3(57.10126f, 3724.255f, 39.72771f), 196.2136f, 45f),
                new GangConditionalLocation(new Vector3(58.31903f, 3724.607f, 39.72731f), 176.8168f, 45f),
                new GangConditionalLocation(new Vector3(66.5742f, 3726.808f, 39.71051f), 173.2846f, 45f),
                new GangConditionalLocation(new Vector3(64.92879f, 3726.43f, 39.7145f), 256.0423f, 45f),
                new GangConditionalLocation(new Vector3(58.89564f, 3698.918f, 39.75497f), 319.3528f, 45f),
                new GangConditionalLocation(new Vector3(57.78175f, 3699.333f, 39.75499f), 307.2412f, 45f),
            },
