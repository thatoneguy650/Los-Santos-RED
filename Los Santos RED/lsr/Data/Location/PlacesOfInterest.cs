    ...
    private void DefaultConfig_Businesses()
    {
        Businesses = new List<Business>()
        {
            ...
            new Business(new Vector3(758.9064f,-697.2536f,28.76577f),271.9622f,"Counterfeit Factory", "Passports, driving licenses and cash")
            {
                ...
                PayoutFrequency = 7,
                SalesPrice = 150000,
                FullName = "La Mesa, Counterfeit Factory",
                PossibleModItemPayouts = new List<string>() { "Marked Cash Stack", "Drivers License" },
                ModItemPayoutAmount = 4,
