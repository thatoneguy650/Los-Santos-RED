...
public class GameSaves : IGameSaves
{
    ...
    private void AddLSPDCops()
    {
        ...
        GameSave LSPDMaleSave = new GameSave("Officer Sawyer Ward", 120000, "MP_M_FREEMODE_01", true, MalePoliceVariation, MalePoliceWeapons, new List<VehicleVariation>() { new VehicleVariation("police2", -1, -1, new LSR.Vehicles.LicensePlate("LS 1299", 3, false), new Vector3(-372.865936f, -308.577576f, 32.1299629f), 280.34967f)});
    ...
    private void AddSheriffCops()
    {
        ...
        List<StoredWeapon> MalePoliceWeapons = new List<StoredWeapon>{
            ...
            new StoredWeapon(0xBFE256D4, Vector3.Zero, new WeaponVariation(), 45),
            new StoredWeapon(911657153, Vector3.Zero, new WeaponVariation(), 0), };
        GameSave MaleSave = new GameSave("Officer Michael Jonas", 120000, "MP_M_FREEMODE_01", true, MalePoliceVariation, MalePoliceWeapons, new List<VehicleVariation>() );
        ...
        GameSave FemaleSave = new GameSave("Officer Jennifer Lemont", 120000, "MP_F_FREEMODE_01", false, FemalePolice, FemalePoliceWeapons, new List<VehicleVariation>() );
    ...
    private void AddNooseCops()
    {
        ...
        List<StoredWeapon> MalePoliceWeapons = new List<StoredWeapon>{
            ...
            new StoredWeapon(0xBFE256D4, Vector3.Zero, new WeaponVariation(), 45),
            new StoredWeapon(911657153, Vector3.Zero, new WeaponVariation(), 0), };
        GameSave MaleSave = new GameSave("Officer Thomas Paris", 120000, "MP_M_FREEMODE_01", true, MalePoliceVariation, MalePoliceWeapons, new List<VehicleVariation>());
        MaleSave.PlayerPosition = new Vector3(-368.985046f, -305.745453f, 32.7422867f);
        MaleSave.PlayerHeading = 45f;
        MaleSave.CurrentDateTime = new System.DateTime(System.DateTime.Now.Year, System.DateTime.Now.Month, System.DateTime.Now.Day, 13, 30, 0);
        ...
        GameSave FemaleSave = new GameSave("Officer Annika Hansen", 120000, "MP_F_FREEMODE_01", false, FemalePolice, FemalePoliceWeapons, new List<VehicleVariation>());
        FemaleSave.PlayerPosition = new Vector3(-368.985046f, -305.745453f, 32.7422867f);
        FemaleSave.PlayerHeading = 45f;
        FemaleSave.CurrentDateTime = new System.DateTime(System.DateTime.Now.Year, System.DateTime.Now.Month, System.DateTime.Now.Day, 13, 30, 0);
    ...
    private void AddFIBHRTCops()
    {
        ...
        List<StoredWeapon> MalePoliceWeapons = new List<StoredWeapon>{
            ...
            new StoredWeapon(0xBFE256D4, Vector3.Zero, new WeaponVariation(), 45),
            new StoredWeapon(911657153, Vector3.Zero, new WeaponVariation(), 0), };
        GameSave MaleSave = new GameSave("Officer Jack Bauer", 120000, "MP_M_FREEMODE_01", true, MalePoliceVariation, MalePoliceWeapons, new List<VehicleVariation>());
        MaleSave.PlayerPosition = new Vector3(-368.985046f, -305.745453f, 32.7422867f);
        MaleSave.PlayerHeading = 45f;
        MaleSave.CurrentDateTime = new System.DateTime(System.DateTime.Now.Year, System.DateTime.Now.Month, System.DateTime.Now.Day, 13, 30, 0);
        ...
        GameSave FemaleSave = new GameSave("Officer Ashley Simmons", 120000, "MP_F_FREEMODE_01", false, FemalePolice, FemalePoliceWeapons, new List<VehicleVariation>());
        FemaleSave.PlayerPosition = new Vector3(-368.985046f, -305.745453f, 32.7422867f);
        FemaleSave.PlayerHeading = 45f;
        FemaleSave.CurrentDateTime = new System.DateTime(System.DateTime.Now.Year, System.DateTime.Now.Month, System.DateTime.Now.Day, 13, 30, 0);
