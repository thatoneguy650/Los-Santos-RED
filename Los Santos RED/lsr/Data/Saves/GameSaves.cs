...
public class GameSaves : IGameSaves
{
    ...
    private void DefaultConfig()
    {
        ...
        VehicleVariation myVehicle = new VehicleVariation("sentinel", 0, 0, new LSR.Vehicles.LicensePlate("FG33456A", 0, false));
        ...
        GameSave AlexisGameSave = new GameSave("Alexis Davis", 9500, "MP_F_FREEMODE_01", false, AlexisVariation, AlexisWeapons, myVehicle) { CurrentHeadBlendData = HeadBlend, CurrentHeadOverlays = HeadOverlays, CurrentPrimaryHairColor = 11, CurrentSecondaryColor = 12 };
        ...
        List<HeadOverlay> HeadOverlays2 = new List<HeadOverlay>() {
            new HeadOverlay(0,"Blemishes") { Index = 255,Opacity = 1.0f, PrimaryColor = 0,SecondaryColor = 0},
            new HeadOverlay(1, "Facial Hair") { ColorType = 1,Index = 255,Opacity = 1.0f, PrimaryColor = 0,SecondaryColor = 0 },
            new HeadOverlay(2, "Eyebrows") { ColorType = 1,Index = 3,Opacity = 1.0f, PrimaryColor = 0,SecondaryColor = 0 },
            new HeadOverlay(3, "Ageing") {Index = 255,Opacity = 1.0f, PrimaryColor = 0,SecondaryColor = 0 },
            ...
            new HeadOverlay(11, "Body Blemishes") { Index = 255,Opacity = 1.0f, PrimaryColor = 0,SecondaryColor = 0 },
            new HeadOverlay(12, "Add Body Blemishes"){Index = 255,Opacity = 1.0f, PrimaryColor = 0,SecondaryColor = 0 },};
        HeadBlendData HeadBlend2 = new HeadBlendData(12, 31, 0, 12, 31, 0, 0.8f, 0.2f, 0.0f);
        VehicleVariation myVehicle2 = new VehicleVariation("sentinel", 0, 0, new LSR.Vehicles.LicensePlate("FG33456A", 0, false));
        GameSave AlexisGameSave2 = new GameSave("Alexis C Davis", 9500, "MP_F_FREEMODE_01", false, AlexisVariation2, AlexisWeapons2, myVehicle2) { CurrentHeadBlendData = HeadBlend2, CurrentHeadOverlays = HeadOverlays2, CurrentPrimaryHairColor = 57, CurrentSecondaryColor = 5 };
