...
public class PoliceSettings
{
    ...
    public int PedSpawnLimit_Wanted1 { get; set; } = 7;//7;
    public int PedSpawnLimit_Wanted2 { get; set; } = 9;//9;
    public int PedSpawnLimit_Wanted3 { get; set; } = 14;//13;
    public int PedSpawnLimit_Wanted4 { get; set; } = 18;
    public int PedSpawnLimit_Wanted5 { get; set; } = 22;
    ...
    public int VehicleSpawnLimit_Wanted3 { get; set; } = 12;
    public int VehicleSpawnLimit_Wanted4 { get; set; } = 14;
    public int VehicleSpawnLimit_Wanted5 { get; set; } = 16;
    ...
    public int KillLimit_Wanted6 { get; set; } = 20;
