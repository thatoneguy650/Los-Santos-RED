...
public class DispatchablePeople : IDispatchablePeople
{
    ...
    private void DefaultConfig_FullExpandedJurisdiction()
    {
        ...
        List<DispatchablePerson> StandardCops_FEJ = new List<DispatchablePerson>() {
            ...
            //LSPD SWAT
            new DispatchablePerson("mp_m_freemode_01",0,20) { ArmorMin = 50,ArmorMax = 50,RandomizeHead = true,MinWantedLevelSpawn = 3,OverrideVoice = new List<string>() { "S_M_Y_SWAT_01_WHITE_FULL_01", "S_M_Y_SWAT_01_WHITE_FULL_02", "S_M_Y_SWAT_01_WHITE_FULL_03", "S_M_Y_SWAT_01_WHITE_FULL_04" },
                RequiredVariation = new PedVariation(
                    new List<PedComponent>() {
            ...
            new DispatchablePerson("mp_f_freemode_01",0,20) { ArmorMin = 50,ArmorMax = 50,RandomizeHead = true,MinWantedLevelSpawn = 3,OverrideVoice = new List<string>() { "S_F_Y_COP_01_WHITE_FULL_01", "S_F_Y_COP_01_WHITE_FULL_02", "S_F_Y_COP_01_BLACK_FULL_01", "S_F_Y_COP_01_BLACK_FULL_02" },
                RequiredVariation = new PedVariation(
                    new List<PedComponent>() {
                        new PedComponent(1, 185, 0, 0),
  ...
  new PedComponent(5,48,0),
        ...
        List<DispatchablePerson> BCSheriffPeds_FEJ = new List<DispatchablePerson>() {
            ...
            // SWAT
            new DispatchablePerson("mp_m_freemode_01", 0, 20){
                ArmorMin = 50,ArmorMax = 50,MinWantedLevelSpawn = 4, MaxWantedLevelSpawn = 4, DebugName = "<Male BCSO SWAT Uniform>",
            ...
            new DispatchablePerson("mp_f_freemode_01", 0, 20){
                ArmorMin = 50,ArmorMax = 50,MinWantedLevelSpawn = 4, MaxWantedLevelSpawn = 4, DebugName = "<Female BCSO SWAT Uniform>",
                RandomizeHead = true, OverrideVoice = new List<string>() { "S_F_Y_COP_01_WHITE_FULL_01", "S_F_Y_COP_01_WHITE_FULL_02", "S_F_Y_COP_01_BLACK_FULL_01", "S_F_Y_COP_01_BLACK_FULL_02" },
                RequiredVariation = new PedVariation(
                    new List<PedPropComponent>(){
                        new PedPropComponent(0, 149, 1),
            ...
            new DispatchablePerson("mp_m_freemode_01", 0, 0)
    {
        ...
        List<DispatchablePerson> NOOSEPIAPeds_FEJ = new List<DispatchablePerson>() {
            ...
            //PIA TRU 
            new DispatchablePerson("mp_m_freemode_01",0,50) { MinWantedLevelSpawn = 4, MaxWantedLevelSpawn = 4, ArmorMin = 50, ArmorMax = 50, CombatAbilityMin = 1, CombatAbilityMax = 2,
            ...
            new DispatchablePerson("mp_f_freemode_01",0,50) { MinWantedLevelSpawn = 4, MaxWantedLevelSpawn = 4, ArmorMin = 50, ArmorMax = 50, CombatAbilityMin = 1, CombatAbilityMax = 2,
        ...
        List<DispatchablePerson> SAHPPeds_FEJ = new List<DispatchablePerson>() {
            ...
            //SAHP SWAT
            new DispatchablePerson("mp_m_freemode_01",0,20) { RandomizeHead = true,MinWantedLevelSpawn = 3, OverrideVoice = new List<string>() { "S_M_Y_SWAT_01_WHITE_FULL_01", "S_M_Y_SWAT_01_WHITE_FULL_02", "S_M_Y_SWAT_01_WHITE_FULL_03", "S_M_Y_SWAT_01_WHITE_FULL_04" },GroupName = "StandardSAHP",
                RequiredVariation = new PedVariation(
                    new List<PedComponent>() {
  ...
  new PedComponent(5,48,0),
    ...
    private void DefaultConfig_FullExpandedJurisdictionEXTRA(List<DispatchablePersonGroup> PeopleConfig_EUP)
    {
        ...
        List<DispatchablePerson> LSCoFD_FEJ = new List<DispatchablePerson>()
        {
            new DispatchablePerson("mp_m_freemode_01", 0, 0)
            {
        ...
        List<DispatchablePerson> BCFD_FEJ = new List<DispatchablePerson>()
        {
            new DispatchablePerson("mp_m_freemode_01", 0, 0)
            {
        ...
        List<DispatchablePerson> CoastGuard_FEJ = new List<DispatchablePerson>()
        {
            ...
            new DispatchablePerson("mp_f_freemode_01", 0, 0)
            {
                DebugName = "<Female USCG Fatigues>",
                RandomizeHead = true,
                OverrideVoice = new List<string>()
                {
                    "S_F_Y_COP_01_WHITE_FULL_01",
            ...
            new DispatchablePerson("mp_m_freemode_01", 0, 0)
            {
                DebugName = "<Male U.S Coast Guard>",
                RandomizeHead = true,
                OverrideVoice = new List<string>()
                {
                    "S_M_Y_COP_01_WHITE_FULL_01",
            ...
            new DispatchablePerson("mp_f_freemode_01", 0, 0)
            {
                DebugName = "<Female U.S Coast Guard>",
                RandomizeHead = true,
                OverrideVoice = new List<string>()
                {
                    "S_F_Y_COP_01_WHITE_FULL_01",
            ...
            new DispatchablePerson("mp_f_freemode_01", 0, 0)
            {
                DebugName = "<Female USCG Onepiece>",
                RandomizeHead = true,
                OverrideVoice = new List<string>()
                {
                    "S_F_Y_COP_01_WHITE_FULL_01",
            ...
            new DispatchablePerson("mp_f_freemode_01", 0, 0)
            {
                DebugName = "<Female USCG Jumpsuit>",
                RandomizeHead = true,
                OverrideVoice = new List<string>()
                {
                    "S_F_Y_COP_01_WHITE_FULL_01",
        ...
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("SanFire_FEJ", SanFire_FEJ));
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("Lifeguards_FEJ", Lifeguards_FEJ));
        ...
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("SanAndreasMedicalServices_FEJ", SanAndreasMedicalServices_FEJ));
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("CoastGuard_FEJ", CoastGuard_FEJ));
        ...
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("GruppeSechSecurity_FEJ", GruppeSechSecurity_FEJ));
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("GenericSecurity_FEJ", GenericSecurity_FEJ));
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("MerryweatherSecurity_FEJ", MerryweatherSecurity_FEJ));
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("MerryweatherPMC_FEJ", MerryweatherPMC_FEJ));
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("BobcatSecurity_FEJ", BobcatSecurity_FEJ));
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("SecuroServ_FEJ", SecuroServ_FEJ));
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("LockNLoadSecurity_FEJ", LockNLoadSecurity_FEJ));
        PeopleConfig_EUP.Add(new DispatchablePersonGroup("ChuffSecurity_FEJ", ChuffSecurity_FEJ));
