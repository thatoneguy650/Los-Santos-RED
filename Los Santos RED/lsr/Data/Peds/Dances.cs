...
using System.Linq;
    ...
    public class Dances : IDances
    {
        ...
        DanceLookups = new List<DanceData>()
        {
            ...
            new DanceData("Mountain Dancer Base","special_ped@mountain_dancer@base","base"),
            new DanceData("Mountain Dancer Verse","special_ped@mountain_dancer@monologue_4@monologue_4a","mnt_dnc_verse"),
            new DanceData("Mountain Dancer Butt Wag","special_ped@mountain_dancer@monologue_3@monologue_3a","mnt_dnc_buttwag"),
            new DanceData("Mountain Dancer Angel","special_ped@mountain_dancer@monologue_2@monologue_2a","mnt_dnc_angel"),
            new DanceData("Mountain Dancer Heaven","special_ped@mountain_dancer@monologue_1@monologue_1a","mtn_dnc_if_you_want_to_get_to_heaven"),

            new DanceData("NME Away Dance B-26","anim@scripted@nightclub@dj@kmuzk@andme@","nme_away_dance_b_26"),
            ...
            new DanceData("Hi Dance Crown (F) 09-1","anim@amb@nightclub_island@dancers@crowddance_groups@groupe@","hi_dance_crowd_09_v1_female^1"),
            ...
            new DanceData("hi_dance_crowd_09_v1_male^1","anim@amb@nightclub_island@dancers@crowddance_groups@groupe@","hi_dance_crowd_09_v1_male^1"),
            ...
            new DanceData("hi_dance_crowd_15_v1_male^1","anim@amb@nightclub_island@dancers@crowddance_groups@groupe@","hi_dance_crowd_15_v1_male^1"),
            new DanceData("hi_dance_crowd_15_v2_female^1","anim@amb@nightclub_island@dancers@crowddance_groups@groupe@","hi_dance_crowd_15_v2_female^1"),
            new DanceData("hi_dance_crowd_15_v2_female^2","anim@amb@nightclub_island@dancers@crowddance_groups@groupe@","hi_dance_crowd_15_v2_female^2"),
            ...
            new DanceData("hi_dance_facedj_09_v1_female^1","anim@amb@nightclub_island@dancers@crowddance_facedj@hi_intensity","hi_dance_facedj_09_v1_female^1"),
            ...
            new DanceData("hi_dance_facedj_09_v1_female^4","anim@amb@nightclub_island@dancers@crowddance_facedj@hi_intensity","hi_dance_facedj_09_v1_female^4"),
            ...
            new DanceData("]mi_dance_facedj_11_v1_female^1","anim@amb@nightclub_island@dancers@crowddance_facedj@med_intensity","]mi_dance_facedj_11_v1_female^1"),
            ...
            new DanceData("]mi_dance_facedj_11_v1_female^4","anim@amb@nightclub_island@dancers@crowddance_facedj@med_intensity","]mi_dance_facedj_11_v1_female^4"),
            ...
            new DanceData("Private Dance 01","mini@strip_club@private_dance@idle","priv_dance_idle"),
