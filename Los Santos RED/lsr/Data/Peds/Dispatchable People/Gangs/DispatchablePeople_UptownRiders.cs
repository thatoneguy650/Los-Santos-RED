...
public class DispatchablePeople_UptownRiders
{
    ...
    private List<string> DefaultVoicesFemale = new List<string>() { "A_F_Y_TOURIST_01_BLACK_FULL_01", "A_F_Y_TOURIST_01_BLACK_MINI_01" };
    public DispatchablePeople_UptownRiders(DispatchablePeople dispatchablePeople)
    {
        DispatchablePeople = dispatchablePeople;
    }
    public void Setup()
    {
        DispatchablePeople.UptownRidersPeds = new List<DispatchablePerson>() { };
        DefaultPeds();
        MaleFreemodePeds();
        FemaleFreemodePeds();
    }
    ...
    {
        DispatchablePeople.UptownRidersPeds.AddRange(new List<DispatchablePerson>()
        {
    ...
    private void MaleFreemodePeds()
    {
        ...
        //DispatchablePeople.UptownRidersPeds.Add(GeneralMaleBiker1);
        ...
        //DispatchablePeople.UptownRidersPeds.Add(GeneralMaleBiker2);
        ...
        //DispatchablePeople.UptownRidersPeds.Add(GeneralMaleBiker3);
        ...
        //DispatchablePeople.UptownRidersPeds.Add(GeneralMaleBiker4);
        ...
        DispatchablePeople.UptownRidersPeds.Add(GeneralMaleBiker5);
    }

    private void FemaleFreemodePeds()
    {
        PedPropComponent DefaultFemaleHelmet = new PedPropComponent(1, 181, 0);
        float NoHelmetPercentage = 95f;
        ...
        //DispatchablePeople.UptownRidersPeds.Add(GeneralFemaleBiker1);
        ...
        //DispatchablePeople.UptownRidersPeds.Add(GeneralFemaleBiker2);
        ...
        //DispatchablePeople.UptownRidersPeds.Add(GeneralFemaleBiker3);
        ...
        //DispatchablePeople.UptownRidersPeds.Add(GeneralFemaleBiker4);
        ...
        DispatchablePeople.UptownRidersPeds.Add(GeneralFemaleBiker5);
    }
    private OptionalAppliedOverlayLogic TShirtOverlays(bool isMale)
    {
        ...
        if (isMale)
        {
            ...
            {
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_036_M","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_037_M","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_040_M","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_041_M","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_042_M","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_043_M","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_044_M","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_045_M","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_046_M","ZONE_TORSO"),
            };
        }
        else
        {
            toreturn.OptionalAppliedOverlays = new List<OptionalAppliedOverlay>()
            {
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_036_F","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_037_F","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_040_F","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_041_F","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_042_F","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_043_F","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_044_F","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_045_F","ZONE_TORSO"),
                new OptionalAppliedOverlay("mpBiker_overlays","MP_Biker_Tee_046_F","ZONE_TORSO"),
