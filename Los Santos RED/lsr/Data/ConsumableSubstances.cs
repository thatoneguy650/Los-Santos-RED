...
public class ConsumableSubstances : IConsumableSubstances
{
    ...
    private void DefaultConfig()
    {
        ConsumableSubstancesList = new List<ConsumableSubstance>
        {
            ...
            new ConsumableSubstance("Taco",eConsumableType.Eat,eConsumableCategory.Food,"prop_food_bs_chips",57005,new Vector3(0.12f, 0.0f, -0.06f),new Rotator(-77.0f, 23.0f, 0.0f)) { Price = 2 },
            //burritos, tortas, tostadas, tamales, quesadillas, enchiladas, carne asada and chiles rellenos
