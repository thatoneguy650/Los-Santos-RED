                ...
                if (agency != null)
                {
                    ...
                    if (VehicleType != null)
                    {
                        ...
                        if (PersonType != null)
                        {
                            try
                            {
                                SpawnTask spawnTask = new SpawnTask(agency, spawnLocation, VehicleType, PersonType, Settings.SettingsManager.FireSettings.ShowSpawnedBlips, Settings, Weapons, Names, true, RandomHeadList);
