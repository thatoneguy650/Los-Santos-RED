...
public class HaircutInteract : InteriorInteract
{
    ...
    //{
    //    if (TotalCash <= BarberShop.DrawerCashGainedPerAnimation)
    //    {
    ...
    //    else
    //    {
    //        Player.BankAccounts.GiveMoney(BarberShop.DrawerCashGainedPerAnimation, false);
    //        BarberShop.PlaySuccessSound();
    //        TotalCash -= BarberShop.DrawerCashGainedPerAnimation;
