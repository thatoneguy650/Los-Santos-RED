...
public class Cop : PedExt
{
    ...
    //    Pistol = Weapons.WeaponsList.Where(x => x.Name.ToLower() == PistolToPick.ModelName.ToLower() && x.Category == WeaponCategory.Pistol).PickRandom();
    //    IssuedPistol = Pistol;
    ...
    //    IssuedHeavy = Weapons.WeaponsList.Where(x => x.Name.ToLower() == HeavyToPick.ModelName.ToLower() && x.Category != WeaponCategory.Pistol).PickRandom();
